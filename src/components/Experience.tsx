...
// // // /* Company logo tile – falls back to the company's initials if the image can't load */
...
// // //   return (
// // //     <div className="h-14 sm:h-16 min-w-[3.5rem] sm:min-w-[4rem] max-w-[8.5rem] rounded-xl bg-white border border-gray-200 dark:border-gray-600 shadow-sm flex items-center justify-center overflow-hidden flex-shrink-0">
// // //       {src && !failed ? (
// // //         <img
// // //           src={src}
// // //           alt={`${name} logo`}
...
// // //         />
// // //       ) : (
// // //         <span className="px-3 text-lg font-bold text-gray-500">{initials}</span>
// // //       )}
// // //     </div>
// // //   );
// // // };

// // // type Tech = { name: string; icon: string | ReactNode | null };
...
// // //   period?: string;
// // //   type?: string;
// // //   achievements: { mobile: string[]; desktop: string[] };
// // //   technologies: Tech[];
// // // }
...
// // //       // TODO: add your Amazon dates, job type (e.g. "Full-time"), achievements and technologies.
// // //       // Anything left empty is simply hidden on the page, so nothing incorrect is shown.
// // //       period: "",
// // //       type: "",
// // //       achievements: {
// // //         mobile: [],
...
// // //       company: "Webgeon Results",
// // //       logo: "https://webgeon.com/open-graph/1200x630.png",
...
// // //           "Tested and integrated APIs using Postman",
// // //           "Managed data with MongoDB and MySQL",
// // //           "Led Gym Management Software: member tracking, payments, admin dashboards"
// // //         ],
// // //         desktop: [
// // //           "Developed and maintained adaptive user interfaces using Next.js, Tailwind CSS, and JavaScript",
// // //           "Implemented interactive UI components and optimized front-end performance for seamless user experiences",
...
// // //           "Used VS Code and Eclipse for streamlined development and debugging",
// // //           "Played an active role in team discussions, demonstrating decision-making abilities and contributing to timely project delivery",
// // //           "Led the development of a Gym Management Software, focusing on member tracking, payment history, and admin dashboards"
// // //         ]
// // //       },
// // //       technologies: [
// // //         { name: "Next.js", icon: "/assets/icons/nextjs.svg" },
...
// // //       title: "Embedded Systems Intern",
// // //       company: "Next Gen Pro",
// // //       logo: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRgIGT_Hr3HR5GIjHz4aK3zf7NsPoTHh6tXoU6djXg4L0D2MXsSHPdI8-LL&s=10",
...
// // //       title: "Python Full Stack Development Intern",
// // //       company: "TechMaghi",
// // //       logo: "", // no logo yet – initials are shown until you add one
// // //       period: "23 Jun 2024 - 29 Jun 2024",
// // //       type: "Internship",
// // //       achievements: [
// // //         "Created a dynamic blog web application allowing users to create, publish, and share stories",
// // //         "Worked across the full stack using Python, HTML, CSS, JavaScript, and database integration",
...
// // //           <div className="grid gap-6">
// // //             {workExperience.map((job, index) => {
// // //               const hasAchievements = job.achievements.mobile.length > 0 || job.achievements.desktop.length > 0;
// // //               const hasTech = job.technologies.length > 0;
// // //               return (
// // //                 <Card
// // //                   key={index}
// // //                   className="bg-white/50 dark:bg-gray-800/50 backdrop-blur border-gray-200 dark:border-gray-700 overflow-hidden transition-all duration-300 hover:shadow-xl hover:scale-[1.02] hover:-translate-y-1 cursor-pointer"
...
// // //                     </div>
// // //                   </CardHeader>
// // //                   {(hasAchievements || hasTech) && (
// // //                     <CardContent className="pt-6">
// // //                       {hasAchievements && (
// // //                         <div className={hasTech ? "mb-6" : ""}>
// // //                           <h4 className="font-semibold text-lg mb-3 flex items-center gap-2">
// // //                             <Award className="w-5 h-5 text-blue-600" />
// // //                             Key Achievements
// // //                           </h4>
...
// // //                 <CardHeader className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 dark:from-purple-500/20 dark:to-pink-500/20">
// // //                   <div className="flex items-start gap-4">
// // //                     <CompanyLogo src={internship.logo} name={internship.company} />
// // //                     <div className="flex-1 min-w-0">
// // //                       <div className="flex flex-wrap items-center gap-2 mb-2">
// // //                         <Badge variant="secondary" className="bg-purple-600 text-white">
// // //                           {internship.type}
...
// //       company: "Amazon",
// //       logo: "https://static.vecteezy.com/system/resources/thumbnails/019/136/319/small/amazon-logo-amazon-icon-free-free-vector.jpg",
// //       // TODO: add your Amazon dates and job type (e.g. "Full-time"). Empty fields are hidden on the page.
// //       period: "",
// //       type: "",
// //       achievements: {
// //         mobile: [
// //           "Annotated and reviewed data to help train and improve ML models",
// //           "Followed detailed guidelines to keep labeling accurate and consistent",
// //           "Ran quality checks and flagged errors and edge cases"
// //         ],
// //         desktop: [
// //           "Annotated, labeled, and reviewed large volumes of data used to train and improve machine learning models",
// //           "Followed detailed project guidelines to keep data labeling accurate, consistent, and high quality",
// //           "Performed quality checks, flagged errors and edge cases, and helped improve overall data quality"
// //         ]
// //       },
// //       technologies: []
// //     },
...
// //       title: "Python Full Stack Development Intern",
// //       company: "TechMaghi",
// //       logo: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRp5r3mPbKMLqpHVAP0Ou4i0Ly8QMjlW6V1kHTkh90Qvpw9ny-jhRX5fEA&s=10",
// //       period: "23 Jun 2024 - 29 Jun 2024",
// //       type: "Internship",
// //       achievements: [
// //         "Created a dynamic blog web application allowing users to create, publish, and share stories",
...
// //       // TODO: add your school name, location, years (start it from your first year in Class 1 or later – no LKG),
// //       // website and your Class 10 score. Empty fields are hidden on the page.
// //       institution: "",
// //       location: "",
// //       website: "",
// //       period: "",
...
const Experience = () => {
  ...
  const education: Education[] = [
    ...
    },
    {
      ...
      institution: "Holy Child Central School",
      location: "Kerala, India",
      website: "https://www.holychildicsecentralschool.com/",
      // TODO: add years (start from Class 1 or later – no LKG) and your Class 10 score. Empty fields are hidden.
      period: "",
      percentage: "",
      type: "Secondary School",
      color: "from-indigo-500/10 to-pink-500/10"

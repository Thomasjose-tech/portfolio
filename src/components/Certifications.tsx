...
// // // //   location?: string;
// // // //   skills?: string[];
// // // //   image?: string;      // local image path (for certificates stored in your project)
// // // //   driveId?: string;    // Google Drive file id (for certificates stored in Google Drive)
// // // //   score?: string;
// // // //   level?: string;
// // // //   verifyUrl?: string;
// // // //   details?: {
...
// // // // /* ── Image helpers: work for both local images and Google Drive files ──
// // // //    Drive files must be shared as "Anyone with the link can view". */
// // // // const getCertImage = (cert: Certificate, size: "card" | "full" = "card") => {
// // // //   if (cert.driveId) {
// // // //     return `https://drive.google.com/thumbnail?id=${cert.driveId}&sz=${size === "full" ? "w2000" : "w800"}`;
// // // //   }
// // // //   return cert.image || "/placeholder.svg";
// // // // };

// // // // const getCertDownloadUrl = (cert: Certificate) =>
// // // //   cert.driveId
// // // //     ? `https://drive.google.com/uc?export=download&id=${cert.driveId}`
// // // //     : cert.image || "";
...
// // // //     // ── New certificates (stored in Google Drive) ──
// // // //     // TODO: add the issue date for each one (e.g. date: "Aug 2025"). Empty dates are hidden on the card.
// // // //     {
// // // //       title: "AWS Certificate",
// // // //       issuer: "Amazon Web Services",
// // // //       date: "",
// // // //       type: "Professional Certification",
// // // //       description: "Amazon Web Services certification demonstrating practical knowledge of AWS cloud services and core cloud computing concepts",
// // // //       skills: ["AWS Cloud", "Cloud Computing", "Cloud Services", "Cloud Security", "Cloud Architecture"],
// // // //       driveId: "1nl2LVICHXixbW9-z-MBCUtCawwy4S-bu"
// // // //     },
// // // //     {
...
// // // //       date: "",
// // // //       type: "Professional Certification",
// // // //       description: "Oracle certification covering Oracle Cloud Infrastructure services, including compute, storage, networking, and security",
// // // //       skills: ["Oracle Cloud", "Cloud Infrastructure", "Compute & Storage", "Networking", "Cloud Security"],
// // // //       driveId: "1p5lFBj9HicU-x3mbhTdM_rQw6r6JwARf"
// // // //     },
// // // //     {
...
// // // //       date: "",
// // // //       type: "Professional Certification",
// // // //       description: "Oracle certification focused on building and using AI agents within Oracle Fusion Cloud applications",
// // // //       skills: ["Oracle Fusion", "AI Agents", "Generative AI", "Cloud Applications", "Business Automation"],
// // // //       driveId: "1M1-BCnfNxBCyLFvplODxqtsCZKwD7Oui"
// // // //     },
// // // //     {
// // // //       title: "Full Stack Development and DSA",
// // // //       issuer: "EMRTCE",
// // // //       date: "",
// // // //       type: "Professional Certification",
// // // //       description: "Certificate for completing training in full stack web development along with data structures and algorithms",
// // // //       skills: ["Full Stack Development", "Data Structures", "Algorithms", "Problem Solving", "Web Development"],
// // // //       driveId: "1kLwBr2jVGqznyPUfM5Y0tkeLe4QTbg6Z"
// // // //     },
...
// // // //     const link = document.createElement('a');
// // // //     link.href = getCertDownloadUrl(cert);
// // // //     link.download = `${cert.title.replace(/\s+/g, '-').toLowerCase()}-certificate.png`;
...
// // //         {/* Pagination and Certificates Display */}
// // //         <div className={`space-y-8 transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
// // //           {/* Cards with the arrows on the left and right sides */}
...
// // //               }}
// // //               disabled={currentPage === 0}
// // //               className="absolute left-1 md:left-0 top-1/2 -translate-y-1/2 z-20 h-10 w-10 md:h-12 md:w-12 rounded-full border-primary/20 text-primary hover:bg-primary/10 shadow-lg transition-all duration-300 bg-white/80 dark:bg-gray-900/90 backdrop-blur-sm"
// // //             >
// // //               <ChevronLeft size={22} />
// // //             </Button>
...
// // //               }}
// // //               disabled={currentPage === Math.ceil(certifications.length / itemsPerPage) - 1}
// // //               className="absolute right-1 md:right-0 top-1/2 -translate-y-1/2 z-20 h-10 w-10 md:h-12 md:w-12 rounded-full border-primary/20 text-primary hover:bg-primary/10 shadow-lg transition-all duration-300 bg-white/80 dark:bg-gray-900/90 backdrop-blur-sm"
// // //             >
// // //               <ChevronRight size={22} />
// // //             </Button>
// // //           </div>

// // //           {/* Page indicator (arrows are now on the sides of the cards) */}
// // //           {Math.ceil(certifications.length / itemsPerPage) > 1 && (
...
// //               }}
// //               disabled={currentPage === 0}
// //               className="hidden md:inline-flex absolute md:left-0 top-1/2 -translate-y-1/2 z-20 md:h-12 md:w-12 rounded-full border-primary/20 text-primary hover:bg-primary/10 shadow-lg transition-all duration-300 bg-white/80 dark:bg-gray-900/90 backdrop-blur-sm"
// //             >
// //               <ChevronLeft size={22} />
// //             </Button>
...
// //               }}
// //               disabled={currentPage === Math.ceil(certifications.length / itemsPerPage) - 1}
// //               className="hidden md:inline-flex absolute md:right-0 top-1/2 -translate-y-1/2 z-20 md:h-12 md:w-12 rounded-full border-primary/20 text-primary hover:bg-primary/10 shadow-lg transition-all duration-300 bg-white/80 dark:bg-gray-900/90 backdrop-blur-sm"
// //             >
// //               <ChevronRight size={22} />
// //             </Button>
// //           </div>

// //           {/* Page indicator – on md+ the arrows are on the sides of the cards; on mobile they stay here, as before */}
// //           {Math.ceil(certifications.length / itemsPerPage) > 1 && (
// //             <div className="flex justify-center items-center gap-6">
// //               {/* Mobile only: original arrows below the cards */}
// //               <Button
// //                 variant="outline"
// //                 size="lg"
// //                 onClick={() => {
...
// //                 }}
// //                 disabled={currentPage === 0}
// //                 className="md:hidden border-primary/20 text-primary hover:bg-primary/10 transition-all duration-300 rounded-full p-4 bg-white/80 dark:bg-gray-900/90 backdrop-blur-sm"
// //               >
// //                 <ChevronLeft size={24} />
// //               </Button>
          ...
          <Dialog>
            <DialogTrigger asChild>
              <Button 
                variant="outline" 
                size="sm" 
                className="w-full border-primary/20 text-primary hover:bg-primary/10 hover:text-primary text-xs"
              >
                <Eye size={12} className="mr-1" />
                View Certificate
              </Button>
        ...
        <div className={`space-y-8 transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="relative md:px-16">
            <Button
              ...
              onClick={() => setCurrentPage(Math.max(0, currentPage - 1))}
              disabled={currentPage === 0}
              className="hidden md:inline-flex absolute md:left-0 top-1/2 -translate-y-1/2 z-20 md:h-12 md:w-12 rounded-full border-primary/20 text-primary hover:bg-primary/10 hover:text-primary shadow-lg transition-all duration-300 bg-white/80 dark:bg-gray-900/90 backdrop-blur-sm"
            >
              <ChevronLeft size={22} />
            </Button>
            ...
            <Button
              ...
              onClick={() => setCurrentPage(Math.min(Math.ceil(certifications.length / itemsPerPage) - 1, currentPage + 1))}
              disabled={currentPage === Math.ceil(certifications.length / itemsPerPage) - 1}
              className="hidden md:inline-flex absolute md:right-0 top-1/2 -translate-y-1/2 z-20 md:h-12 md:w-12 rounded-full border-primary/20 text-primary hover:bg-primary/10 hover:text-primary shadow-lg transition-all duration-300 bg-white/80 dark:bg-gray-900/90 backdrop-blur-sm"
            >
              <ChevronRight size={22} />
            </Button>
          </div>
          ...
          {Math.ceil(certifications.length / itemsPerPage) > 1 && (
            <div className="flex justify-center items-center gap-6">
              ...
              <Button
                ...
                disabled={currentPage === 0}
                className="md:hidden border-primary/20 text-primary hover:bg-primary/10 hover:text-primary transition-all duration-300 rounded-full p-4 bg-white/80 dark:bg-gray-900/90 backdrop-blur-sm"
              >
                <ChevronLeft size={24} />
              </Button>

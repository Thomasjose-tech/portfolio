...
// // // // // // ── Knowledge Base ─────────────────────────────────────────────────
// // // // // const KB = [
// // // // //   { patterns: ["good morning", "morning"], answer: "Good morning! ☀️ Hope you're having a great start to your day!\n\nI'm Thomas Jose's portfolio assistant. Feel free to ask me about his skills, projects, experience, or how to get in touch!" },
// // // // //   { patterns: ["good afternoon", "afternoon"], answer: "Good afternoon! 🌤️ Great time to explore Thomas's portfolio!\n\nFeel free to ask about his skills, projects, work experience, or contact details." },
// // // // //   { patterns: ["good evening", "evening"], answer: "Good evening! 🌙 Thanks for stopping by!\n\nI'm Thomas Jose's portfolio assistant — ask me anything about his work, skills, or projects!" },
// // // // //   { patterns: ["good night", "night"], answer: "Good night! 🌟 Sweet dreams!\n\nIf you have any questions about Thomas before you go, I'm here to help!" },
// // // // //   { patterns: ["how are you", "how are you doing", "how do you do", "how's it going", "hows it going", "how are things"], answer: "I'm doing great, thanks for asking! 😊\n\nI'm always ready to tell you more about Thomas Jose — his skills, projects, experience, or anything else you'd like to know!" },
// // // // //   { patterns: ["what's up", "whats up", "what is up", "sup", "wassup"], answer: "Not much, just here to help! 😄\n\nYou can ask me about Thomas's skills, projects, work experience, certifications, or how to get in touch with him!" },
// // // // //   { patterns: ["nice to meet you", "pleasure to meet you", "glad to meet you"], answer: "Nice to meet you too! 😊\n\nI'm Thomas Jose's portfolio assistant. I'd love to tell you about his skills, projects, and experience. What would you like to know?" },
// // // // //   { patterns: ["how is thomas", "how is he", "is thomas available", "is he free"], answer: "Thomas is doing great and actively working on exciting projects! 🚀\n\nHe's currently leading development of a Gym Management Software at Webgeon Results and is open to new opportunities!\n\n📧 thomasjose22@gmail.com" },
// // // // //   { patterns: ["okay", "ok", "alright", "got it", "i see", "understood", "makes sense"], answer: "Great! 👍 Feel free to ask me anything else about Thomas — his skills, projects, experience, or how to reach him!" },
// // // // //   { patterns: ["bye", "goodbye", "see you", "take care", "later", "cya"], answer: "Goodbye! 👋 It was great chatting with you!\n\nDon't hesitate to come back if you have more questions about Thomas. Have a wonderful day! 😊" },
// // // // //   { patterns: ["thank you", "thanks", "thankyou", "thank u", "ty", "thx"], answer: "You're welcome! 😊 Happy to help!\n\nFeel free to ask anything else about Thomas anytime!" },
// // // // //   { patterns: ["who made you", "who created you", "who built you", "who made this bot"], answer: "I was created as a portfolio assistant for Thomas Jose! 🤖\n\nThomas is a Web Developer skilled in React, Next.js, and Tailwind CSS. Ask me anything about him!" },
// // // // //   { patterns: ["are you a bot", "are you human", "are you ai", "are you real", "are you an ai"], answer: "I'm a portfolio chatbot assistant built to answer questions about Thomas Jose! 🤖\n\nWhile I'm not human, I know everything about Thomas — his skills, projects, experience, and more. What would you like to know?" },
// // // // //   { patterns: ["what can you do", "what do you know", "help me", "what can i ask", "what should i ask"], answer: "I can answer questions about Thomas Jose! 💡\n\nHere are some things you can ask:\n• 👨‍💻 Skills & Technologies\n• 💼 Work Experience\n• 🚀 Projects\n• 🎓 Education\n• 🏆 Certifications\n• 📬 Contact Information\n• 💪 Strengths & Philosophy\n• 🏋️ Current Projects" },
// // // // //   { patterns: ["tell me something interesting", "fun fact", "interesting fact"], answer: "Here's something interesting about Thomas! 🌟\n\nHe built an IoT-powered Smart Pet Feeder that reduced feeding inconsistencies by 85%, and a Multipurpose Agriculture Robot that improved farming efficiency by 60%! Pretty impressive for someone who specialises in web development, right? 😄" },
// // // // //   { patterns: ["who are you", "what is your name", "tell me about yourself", "introduce yourself", "about thomas", "who is thomas"], answer: "Hi! I'm Thomas Jose's portfolio assistant 🤖\n\nThomas is a Web Developer with 6 months of professional experience at Webgeon Results. He specialises in React, Next.js, and Tailwind CSS, and is passionate about building responsive, user-centric web applications." },
// // // // //   { patterns: ["professional summary", "summary", "bio", "background", "overview"], answer: "📋 Professional Summary\n\nThomas Jose is a Web Developer with 6 months of experience at Webgeon Results, skilled in building responsive web applications using React, Tailwind CSS, and Next.js.\n\nHe writes clean, maintainable code and delivers user-centric solutions, with a strong focus on performance, accessibility, and modern web standards." },
// // // // //   { patterns: ["strengths", "key strengths", "what makes you good", "qualities"], answer: "💪 Key Strengths\n\n• Decision-making skills and team leadership\n• Performance optimisation and accessibility focus\n• Clean, maintainable code practices\n• Timely project delivery\n• Continuous learning and adaptation to new technologies\n• User experience optimisation and responsive design" },
// // // // //   { patterns: ["philosophy", "approach", "mindset", "user-first", "development philosophy"], answer: "💡 Development Philosophy\n\nThomas approaches every project with a user-first mindset, ensuring technical excellence translates into intuitive and engaging user experiences. His goal is to bridge the gap between complex functionality and seamless usability." },
// // // // //   { patterns: ["skills", "technologies", "tech stack", "programming languages", "languages"], answer: "🛠️ Skills & Technologies\n\n📌 Languages: Python 🐍, JavaScript ⚡, HTML 🌐, CSS 🎨\n\n⚛️ Frameworks: Next.js, React, Tailwind CSS\n\n🗄️ Databases: MongoDB, MySQL\n\n🔧 Tools: VS Code, Eclipse, Postman\n\n🤝 Soft Skills: Team Leadership, Decision Making, API Testing, REST API Validation" },
// // // // //   { patterns: ["react", "nextjs", "next.js", "tailwind", "frontend"], answer: "⚛️ Frontend Skills\n\nThomas is proficient in:\n• React – component-driven UI development\n• Next.js – server-side rendering & full-stack React\n• Tailwind CSS – utility-first responsive styling\n\nHe used these daily at Webgeon Results to build adaptive, high-performance web applications." },
// // // // //   { patterns: ["database", "mongodb", "mysql", "data"], answer: "🗄️ Database Skills\n\n• MongoDB – flexible, document-based data storage\n• MySQL – structured relational data\n\nThomas applied both at Webgeon Results to manage different types of application data." },
// // // // //   { patterns: ["experience", "work experience", "job", "webgeon", "current job", "where do you work"], answer: "💼 Professional Experience\n\n🏢 Web Developer — Webgeon Results\n📅 Dec 2023 – Present | Full-time\n\n• Built adaptive UIs with Next.js, Tailwind CSS & JavaScript\n• Optimised front-end performance and UX\n• API testing & integration using Postman\n• Managed data with MongoDB and MySQL\n• Active in team decision-making\n• Leading development of a Gym Management Software" },
// // // // //   { patterns: ["internship", "intern", "nextgen", "techmogul", "embedded", "python full stack"], answer: "🎓 Internship Experience\n\n1️⃣ Embedded Systems Intern — Next Gen Pro\n📅 May 2023 – May 2024\n• Arduino UNO, circuit design, sensor interfacing & automation\n\n2️⃣ Python Full Stack Development Intern — TechMogul\n📅 Jun 2024\n• Built a dynamic blog app using Python, HTML, CSS, JavaScript" },
...
// // // // //   { patterns: ["location", "where are you", "where do you live", "india", "kerala"], answer: "📍 Thomas is based in Kerala, India.\n\nHe is open to remote work and collaboration opportunities globally!" },
// // // // //   { patterns: ["gym", "gym management", "current project", "ongoing"], answer: "🏋️ Current Project — Gym Management Software\n\nLeading development at Webgeon Results:\n• Member tracking system\n• Payment history management\n• Admin dashboards\n\n🔧 Tech: Next.js, React, Tailwind CSS, MongoDB" },
// // // // //   { patterns: ["available", "looking for job", "open to work", "freelance", "opportunity"], answer: "✅ Thomas is open to:\n• Full-time Developer roles\n• Freelance projects\n• Remote collaborations\n\n📧 thomasjose22@gmail.com\n💼 linkedin.com/in/thomas-jose-98b97b220" },
// // // // //   { patterns: ["hobby", "hobbies", "what are your hobbies", "what do you do in free time", "free time", "interests", "passion"], answer: "📚 Hobbies & Interests\n\n• 📖 Reading books\n• 💻 Studying new technologies\n• 🌐 Exploring web development trends\n• 🤖 Building side projects\n\nThomas is passionate about continuous learning and staying up to date with the latest in tech!" },
// // // // //   { patterns: ["why should we hire you"], answer: "Because I write clean, maintainable code, focus on performance and user experience, and adapt quickly to new technologies while working effectively in teams." },
// // // // //   { patterns: ["what are your strengths", "your strengths"], answer: "My strengths include problem-solving, performance optimization, leadership qualities, clean coding practices, and continuous learning." },
// // // // //   { patterns: ["what are your weaknesses", "weakness", "your weakness"], answer: "I sometimes focus deeply on perfection, but I manage time effectively to balance quality with deadlines." },
// // // // //   { patterns: ["why web development"], answer: "I enjoy building interactive and useful digital experiences that solve real-world problems." },
// // // // //   { patterns: ["what is react", "explain react"], answer: "React is a JavaScript library for building user interfaces using reusable components and a virtual DOM." },
// // // // //   { patterns: ["what is nextjs", "explain nextjs", "explain next js"], answer: "Next.js is a React framework that supports server-side rendering, static site generation, and backend APIs." },
// // // // //   { patterns: ["difference react nextjs", "react vs nextjs", "react versus nextjs"], answer: "React is a UI library, while Next.js is a framework built on React that adds routing, SSR, and optimization features." },
// // // // //   { patterns: ["what is tailwind", "explain tailwind"], answer: "Tailwind CSS is a utility-first CSS framework that enables fast UI development using predefined classes." },
// // // // //   { patterns: ["what is mongodb", "explain mongodb"], answer: "MongoDB is a NoSQL database that stores data in flexible document-based JSON format." },
// // // // //   { patterns: ["what is mysql", "explain mysql"], answer: "MySQL is a relational database that stores structured data in tables using SQL queries." },
// // // // //   { patterns: ["difference mongodb mysql", "mongodb vs mysql"], answer: "MongoDB is document-based and flexible, while MySQL is structured and relational." },
// // // // //   { patterns: ["what is ssr", "server side rendering", "server-side rendering"], answer: "Server-Side Rendering renders pages on the server before sending them to the browser for better SEO and performance." },
// // // // //   { patterns: ["what is ssg", "static site generation"], answer: "Static Site Generation pre-builds pages at build time for fast loading performance." },
// // // // //   { patterns: ["what is useeffect", "useeffect hook"], answer: "useEffect is a React hook used to handle side effects like API calls and lifecycle events." },
// // // // //   { patterns: ["what is usestate", "usestate hook"], answer: "useState is a React hook used to manage state inside functional components." },
// // // // //   { patterns: ["what is virtual dom", "virtual dom"], answer: "Virtual DOM is a lightweight copy of the real DOM used by React to optimize UI updates." },
// // // // //   { patterns: ["what is async await", "async await"], answer: "Async/await simplifies handling asynchronous operations in JavaScript." },
// // // // //   { patterns: ["what is rest api", "rest api"], answer: "REST API is a web service architecture using HTTP methods like GET, POST, PUT, DELETE." },
// // // // //   { patterns: ["what is api testing", "api testing"], answer: "API testing ensures endpoints return correct responses. I use Postman for validation." },
// // // // //   { patterns: ["explain your experience"], answer: "At Webgeon Results, I build responsive UIs, optimize performance, integrate APIs, and manage databases." },
// // // // //   { patterns: ["describe gym management"], answer: "It includes member tracking, payment history, and admin dashboards using Next.js and MongoDB." },
// // // // //   { patterns: ["describe smart pet feeder"], answer: "An IoT-based automated pet feeding system with remote monitoring dashboard." },
// // // // //   { patterns: ["describe agriculture robot"], answer: "A robot for soil monitoring, seed sowing, and spraying to improve farming efficiency." },
// // // // //   { patterns: ["describe financuz"], answer: "A financial dashboard for tracking expenses and budget planning." },
// // // // //   { patterns: ["describe chronos"], answer: "A luxury watch e-commerce UI with smooth animations and filtering features." },
// // // // //   { patterns: ["how do you optimize performance", "performance optimization", "optimize"], answer: "By minimizing re-renders, lazy loading, optimizing images, and reducing API calls." },
// // // // //   { patterns: ["what is responsive design", "responsive design"], answer: "Designing websites that adapt to different screen sizes using flexible layouts." },
// // // // //   { patterns: ["what is accessibility", "accessibility"], answer: "Ensuring websites are usable by everyone, including people with disabilities." },
// // // // //   { patterns: ["teamwork", "team work", "team player"], answer: "I communicate clearly and collaborate effectively to achieve team goals." },
// // // // //   { patterns: ["leadership", "lead", "team lead"], answer: "I take initiative, guide teammates, and support decision-making." },
// // // // //   { patterns: ["problem solving", "problem-solving"], answer: "I analyze root causes and implement efficient technical solutions." },
// // // // //   { patterns: ["handle deadlines", "deadlines", "time management"], answer: "I prioritize tasks and follow structured planning to always deliver on time." },
// // // // //   { patterns: ["handle stress", "stress", "pressure"], answer: "I stay organized and focus on solutions instead of pressure." },
// // // // //   { patterns: ["code quality", "clean code", "coding standards"], answer: "I follow clean code principles and modular architecture." },
// // // // //   { patterns: ["version control", "git", "github workflow"], answer: "I use Git for tracking changes and collaboration." },
// // // // //   { patterns: ["deployment", "deploy", "vercel"], answer: "I deploy applications using platforms like Vercel." },
// // // // //   { patterns: ["state management", "state"], answer: "I manage state using React hooks and structured component design." },
// // // // //   { patterns: ["future goals", "career goals", "goal", "where do you see yourself"], answer: "To become a senior developer and lead scalable, impactful projects that make a real difference! 🚀" },
// // // // //   { patterns: ["difference frontend backend", "frontend vs backend"], answer: "Frontend handles UI, backend handles logic and database." },
// // // // //   { patterns: ["what is javascript", "javascript", "js language"], answer: "JavaScript is a programming language for building interactive web applications." },
// // // // //   { patterns: ["what is css", "explain css"], answer: "CSS styles and designs web pages." },
// // // // //   { patterns: ["what is html", "explain html"], answer: "HTML structures web page content." },
// // // // //   { patterns: ["what is nodejs", "nodejs", "node js"], answer: "Node.js allows JavaScript to run on the server side." },
// // // // //   { patterns: ["what is component", "react component"], answer: "A reusable piece of UI logic in React." },
// // // // //   { patterns: ["what is props", "react props"], answer: "Props pass data between React components." },
// // // // //   { patterns: ["what is hook", "react hooks"], answer: "Hooks allow functional components to use state and lifecycle features." },
// // // // //   { patterns: ["what is seo", "seo"], answer: "SEO improves website visibility in search engines." },
// // // // //   { patterns: ["what is middleware", "middleware"], answer: "Middleware processes requests before reaching the main handler." },
// // // // //   { patterns: ["python", "python language"], answer: "Python is a versatile language Thomas uses for scripting, automation, and full-stack dev. He built a blog app using Python during his TechMogul internship." },
// // // // //   { patterns: ["postman", "api tools"], answer: "Thomas uses Postman for API testing, endpoint validation, and REST API integration at Webgeon Results." },
// // // // //   { patterns: ["arduino", "embedded systems", "iot"], answer: "Thomas worked with Arduino UNO, circuit design, sensor interfacing, and automation during his internship at Next Gen Pro." },
// // // // //   { patterns: ["azure", "cloud", "microsoft azure"], answer: "Thomas holds a Microsoft Azure for Data Engineering certification from Coursera, covering cloud data engineering concepts." },
// // // // //   { patterns: ["cgpa", "marks", "grades", "score"], answer: "Thomas completed his B.Tech with a CGPA of 7.45 and scored 87% in Senior Secondary (CBSE)." },
// // // // //   { patterns: ["salary", "ctc", "package", "compensation"], answer: "Thomas is open to discussing compensation based on the role. Please contact him directly at thomasjose22@gmail.com 📧" },
// // // // //   { patterns: ["remote", "work from home", "wfh"], answer: "Yes! Thomas is open to remote work and global collaborations. 📍 Currently based in Kerala, India." },
// // // // //   { patterns: ["english", "english certificate", "language proficiency"], answer: "Thomas holds an EF SET English Certificate at C1 Advanced level (66/100), demonstrating professional English proficiency." },
// // // // // ];
...
// // // // //   for (const entry of KB) {
// // // // //     for (const p of entry.patterns) {
// // // // //       if (cleanInput.includes(p) || p.includes(cleanInput)) return entry.answer;
// // // // //     }
// // // // //   }
// // // // //   const userTokens = tokenize(input);
// // // // //   if (userTokens.length === 0) return "Could you rephrase that? 😊 I'm happy to answer questions about Thomas's skills, projects, experience, or contact info!";
// // // // //   let best: string | null = null;
// // // // //   let bestScore = 0;
// // // // //   for (const { entryIdx, tokens, rawPatterns } of KB_INDEX) {
// // // // //     let score = 0;
// // // // //     let phraseBonus = 0;
// // // // //     for (const ut of userTokens) {
// // // // //       if (tokens.has(ut)) score += 2;
// // // // //       for (const kt of tokens) {
// // // // //         if (kt !== ut && (kt.includes(ut) || ut.includes(kt)) && ut.length > 2) score += 1;
// // // // //       }
// // // // //     }
// // // // //     for (const p of rawPatterns) {
// // // // //       const pTokens = tokenize(p);
// // // // //       const matched = pTokens.filter((t) => userTokens.includes(t)).length;
// // // // //       if (pTokens.length > 0 && matched / pTokens.length >= 0.6) phraseBonus = Math.max(phraseBonus, 3);
// // // // //     }
// // // // //     const finalScore = score + phraseBonus;
// // // // //     if (finalScore > bestScore) { bestScore = finalScore; best = KB[entryIdx].answer; }
// // // // //   }
// // // // //   if (bestScore >= 2 && best) return best;
// // // // //   return "🤔 I'm not sure about that!\n\nYou can ask me about:\n• Skills & Technologies\n• Work Experience\n• Projects\n• Education\n• Certifications\n• Contact Information";
// // // // // }
...
// // // // //       ? "0 25px 60px rgba(0,0,0,0.75),0 8px 24px rgba(59,130,246,0.3)"
// // // // //       : "0 25px 60px rgba(0,0,0,0.16),0 8px 24px rgba(59,130,246,0.14)",
// // // // //     msgBg:        dark ? "linear-gradient(180deg,#0f172a 0%,#1e293b 100%)" : "linear-gradient(180deg,#f8faff 0%,#f2f4f8 100%)",
// // // // //     botBg:        dark ? "#1e293b"  : "#ffffff",
// // // // //     botTxt:       dark ? "#e2e8f0"  : "#1f2937",
// // // // //     botBorder:    dark ? "1px solid #334155" : "1px solid #e5e7eb",
// // // // //     botShadow:    dark ? "0 2px 8px rgba(0,0,0,0.4)" : "0 1px 4px rgba(0,0,0,0.06)",
...
// // // // //   // ── Window sizing ──────────────────────────────────────────────
// // // // //   // On mobile: always full-screen, height = visualViewport height so the
// // // // //   // window SHRINKS with the keyboard rather than sliding up.
// // // // //   // On desktop: fixed bottom-right popup (original behaviour).
// // // // //   const windowStyle: React.CSSProperties = (() => {
// // // // //     if (isMobile || fullscreen) {
// // // // //       // Full-screen on mobile; respect keyboard by using measured viewport height
// // // // //       return {
// // // // //         position:      "fixed",
// // // // //         top:           0,
// // // // //         left:          0,
...
// // // // //   return (
// // // // //     <>
// // // // //       {/* Overlay (desktop fullscreen only) */}
// // // // //       {open && fullscreen && !isMobile && (
// // // // //         <div
// // // // //           style={{ position: "fixed", inset: 0, zIndex: 9998, background: c.overlayBg }}
// // // // //           onClick={() => setFullscreen(false)}
// // // // //         />
// // // // //       )}

// // // // //       {/* Launcher — hide when mobile chat is open */}
// // // // //       {!(isMobile && open) && (
// // // // //         <div className="fixed z-50" style={{ bottom: "5.5rem", right: "1.5rem" }}>
// // // // //           {!open && showBadge && (
// // // // //             <div
...
// // // // //               className="absolute text-sm px-4 py-2 rounded-2xl shadow-lg cursor-pointer select-none"
// // // // //               style={{
// // // // //                 bottom: "100%", right: 0, marginBottom: "0.5rem",
// // // // //                 whiteSpace: "nowrap",
// // // // //                 animation: "fadeSlideIn 0.5s ease forwards",
// // // // //                 background: c.badgeBg, color: c.badgeTxt, border: `1px solid ${c.badgeBdr}`,
// // // // //               }}
// // // // //             >
// // // // //               💬 Ask me anything!
// // // // //             </div>
...
// // // // //                 }}
// // // // //               />
// // // // //               <div className="w-10 h-10 rounded-full bg-white/20 items-center justify-center border-2 border-white/40" style={{ display: "none" }}>
// // // // //                 <Bot size={20} color="white" />
// // // // //               </div>
// // // // //               <span className="absolute bottom-0 right-0 w-2.5 h-2.5 bg-green-400 rounded-full border-2 border-white" />
// // // // //             </div>
...
// // // // //           {/* ── Messages — flex-1 so it fills remaining space, shrinks when keyboard appears ── */}
// // // // //           <div
// // // // //             className="chat-messages flex-1 overflow-y-auto px-4 py-4 space-y-4"
// // // // //             style={{ background: c.msgBg, overscrollBehavior: "contain" }}
// // // // //           >
// // // // //             {messages.map(msg => (
// // // // //               <div
// // // // //                 key={msg.id}
...
// // // // //                       />
// // // // //                       <div className="w-7 h-7 rounded-full items-center justify-center" style={{ display: "none" }}>
// // // // //                         <Bot size={14} color="white" />
// // // // //                       </div>
// // // // //                     </>
// // // // //                   ) : (
// // // // //                     <div className="w-7 h-7 rounded-full flex items-center justify-center" style={{ background: "linear-gradient(135deg,#10b981,#059669)" }}>
// // // // //                       <User size={14} color="white" />
// // // // //                     </div>
// // // // //                   )}
// // // // //                 </div>
...
// // // // //                     style={
// // // // //                       msg.role === "bot"
// // // // //                         ? { background: c.botBg, color: c.botTxt, border: c.botBorder, boxShadow: c.botShadow, borderBottomLeftRadius: "4px" }
// // // // //                         : { background: "linear-gradient(135deg,#3b82f6,#8b5cf6)", color: "white", borderBottomRightRadius: "4px" }
// // // // //                     }
// // // // //                   >
// // // // //                     {msg.text}
// // // // //                   </div>
// // // // //                   <div className="text-xs mt-1 px-1" style={{ color: c.timeTxt, textAlign: msg.role === "user" ? "right" : "left" }}>
// // // // //                     {msg.time}
// // // // //                   </div>
// // // // //                 </div>
// // // // //               </div>
...
// // // // //             {isTyping && (
// // // // //               <div className="flex items-end gap-2">
// // // // //                 <div className="w-7 h-7 rounded-full overflow-hidden flex-shrink-0" style={{ background: "linear-gradient(135deg,#3b82f6,#8b5cf6)" }}>
// // // // //                   <img src="/assets/certificates/photo.jpg" alt="Thomas" className="w-full h-full object-cover object-[50%_25%] rounded-full" onError={e => { e.currentTarget.style.display = "none"; }} />
// // // // //                 </div>
// // // // //                 <div className="px-4 py-3 rounded-2xl flex gap-1 items-center" style={{ background: c.botBg, border: c.botBorder, borderBottomLeftRadius: "4px" }}>
// // // // //                   {[0, 1, 2].map(i => (
// // // // //                     <span key={i} className="w-2 h-2 rounded-full inline-block" style={{ background: "#94a3b8", animation: `typingDot 1.2s ease-in-out ${i * 0.2}s infinite` }} />
// // // // //                   ))}
// // // // //                 </div>
// // // // //               </div>
// // // // //             )}
...
// // // // //             style={{ background: c.chipRowBg, borderTop: c.chipRowBorder, scrollbarWidth: "none" }}
// // // // //           >
// // // // //             {SUGGESTIONS.map(s => (
// // // // //               <button
// // // // //                 key={s}
// // // // //                 onClick={() => send(s)}
// // // // //                 className="flex-shrink-0 text-xs px-3 py-1.5 rounded-full whitespace-nowrap transition-all duration-200 hover:scale-105 active:scale-95"
// // // // //                 style={{ background: c.chipBg, border: `1px solid ${c.chipBorder}`, color: c.chipTxt }}
// // // // //               >
// // // // //                 {s}
// // // // //               </button>
// // // // //             ))}
...
// // // // //           {/* ── Input row ──
// // // // //               flex-shrink-0 keeps it pinned at the bottom.
// // // // //               On mobile the whole window height = visualViewport height,
// // // // //               so this row stays above the keyboard automatically.
// // // // //           ── */}
// // // // //           <div
// // // // //             className="flex items-center gap-2 px-3 py-3 flex-shrink-0"
// // // // //             style={{ background: c.inputRowBg, borderTop: c.inputRowBdr }}
...
// // // // //               placeholder="Ask me anything..."
// // // // //               className="flex-1 text-sm px-3.5 py-2.5 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
// // // // //               style={{ background: c.inputBg, border: `1px solid ${c.inputBdr}`, color: c.inputTxt }}
// // // // //               // Prevent iOS zoom on focus (font-size ≥ 16px)
// // // // //               style={{ background: c.inputBg, border: `1px solid ${c.inputBdr}`, color: c.inputTxt, fontSize: "16px" } as React.CSSProperties}
// // // // //             />
// // // // //             <button
// // // // //               onClick={() => send(input)}
// // // // //               disabled={!input.trim()}
// // // // //               className="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0 transition-all duration-200 hover:scale-110 active:scale-95 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:scale-100"
// // // // //               style={{ background: input.trim() ? "linear-gradient(135deg,#3b82f6,#8b5cf6)" : c.sendDisabled }}
// // // // //             >
// // // // //               <Send size={15} color={input.trim() ? "white" : "#94a3b8"} />
// // // // //             </button>
// // // // //           </div>
...
// // // // //     e.preventDefault();
// // // // //     const emailSubject = encodeURIComponent(formData.subject || "Contact Form Message");
// // // // //     const emailBody    = encodeURIComponent(`Hello Thomas,\n\nName: ${formData.name}\nEmail: ${formData.email}\n\nMessage:\n${formData.message}\n\nBest regards,\n${formData.name}`);
// // // // //     window.location.href = `mailto:thomasjose22@gmail.com?subject=${emailSubject}&body=${emailBody}`;
// // // // //     toast({ title: "Opening Email Client", description: "Your email client will open with the message pre-filled." });
// // // // //   };
...
// // // // //         <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
// // // // //           <div className={`space-y-8 transition-opacity duration-700 ${isVisible ? "animate-fade-up" : "opacity-0"}`} style={{ animationDelay: isVisible ? "0.2s" : "0s" }}>
// // // // //             <div>
// // // // //               <h3 className="text-2xl font-semibold text-foreground mb-4">Let's Connect</h3>
// // // // //               <p className="text-muted-foreground leading-relaxed">
// // // // //                 I'm always excited to discuss new opportunities, innovative projects, or potential collaborations. Whether you have a specific project in mind or just want to chat about technology, feel free to reach out!
// // // // //               </p>
// // // // //             </div>
// // // // //             <div className="space-y-4">
// // // // //               {contactInfo.map((contact, index) => (
// // // // //                 <a key={index} href={contact.href} target={contact.href.startsWith("http") ? "_blank" : undefined} rel={contact.href.startsWith("http") ? "noopener noreferrer" : undefined}
// // // // //                   className="flex items-center gap-4 p-4 rounded-xl border border-border bg-card hover:bg-accent transition-all duration-300 hover:scale-105 group"
// // // // //                 >
// // // // //                   <div className={`p-2 rounded-lg bg-background ${contact.color}`}><contact.icon size={20} /></div>
// // // // //                   <div>
// // // // //                     <div className="text-sm text-muted-foreground">{contact.label}</div>
...
// // // // //             </div>
// // // // //             <div className="flex items-center gap-3 p-4 rounded-xl border border-border bg-card">
// // // // //               <div className="p-2 rounded-lg bg-background text-red-500"><MapPin size={20} /></div>
// // // // //               <div>
// // // // //                 <div className="text-sm text-muted-foreground">Location</div>
// // // // //                 <div className="font-medium text-foreground">Kerala, India</div>
// // // // //               </div>
...
// // // // //           <div className={`transition-opacity duration-700 ${isVisible ? "animate-fade-up" : "opacity-0"}`} style={{ animationDelay: isVisible ? "0.4s" : "0s" }}>
// // // // //             <Card className="shadow-elegant">
// // // // //               <CardHeader>
// // // // //                 <CardTitle>Send Me a Message</CardTitle>
...
// // // // // import { Label } from "@/components/ui/label";
// // // // // import {
// // // // //   Mail, Phone, Github, Linkedin, MapPin, Send, X, Bot, User,
// // // // //   Minimize2, Maximize2, Copy, Check, Trash2, ChevronDown,
// // // // //   PanelRightOpen, Square
// // // // // } from "lucide-react";
// // // // // import { useState, useEffect, useRef, useCallback } from "react";
// // // // // import { useToast } from "@/hooks/use-toast";
...
// // // // // .chat-messages::-webkit-scrollbar-thumb { background:rgba(100,100,120,0.3); border-radius:4px; }
// // // // // .chat-messages { scrollbar-width:thin; scrollbar-color:rgba(100,100,120,0.3) transparent; }
// // // // // .msg-copy-btn { opacity:0; transition:opacity 0.2s; }
// // // // // .msg-wrapper:hover .msg-copy-btn { opacity:1; }
// // // // // `;

// // // // // if (typeof document !== "undefined" && !document.getElementById("chatbot-styles-v2")) {
// // // // //   const s = document.createElement("style");
// // // // //   s.id = "chatbot-styles-v2";
// // // // //   s.textContent = globalStyles;
// // // // //   document.head.appendChild(s);
// // // // // }

// // // // // // ── Knowledge Base (same as before, trimmed for space) ─────────────
// // // // // const KB = [
// // // // //   { patterns:["good morning","morning"], answer:"Good morning! ☀️ Hope you're having a great start!\n\nI'm Thomas Jose's portfolio assistant. Ask me about his skills, projects, experience, or how to get in touch!" },
// // // // //   { patterns:["good afternoon","afternoon"], answer:"Good afternoon! 🌤️ Great time to explore Thomas's portfolio!" },
// // // // //   { patterns:["good evening","evening"], answer:"Good evening! 🌙 Thanks for stopping by! Ask me anything about Thomas's work." },
// // // // //   { patterns:["good night","night"], answer:"Good night! 🌟 Feel free to come back anytime!" },
// // // // //   { patterns:["how are you","how are you doing","how do you do","how's it going","hows it going"], answer:"I'm doing great, thanks! 😊 Always ready to tell you about Thomas Jose!" },
// // // // //   { patterns:["what's up","whats up","sup","wassup"], answer:"Not much, just here to help! 😄 Ask me about Thomas's skills, projects, or experience!" },
// // // // //   { patterns:["nice to meet you","pleasure to meet you"], answer:"Nice to meet you too! 😊 I'm Thomas Jose's portfolio assistant. What would you like to know?" },
// // // // //   { patterns:["how is thomas","is thomas available","is he free"], answer:"Thomas is doing great and actively working on exciting projects! 🚀\n\nHe's open to new opportunities!\n\n📧 thomasjose22@gmail.com" },
// // // // //   { patterns:["okay","ok","alright","got it","i see","understood"], answer:"Great! 👍 Feel free to ask anything else about Thomas!" },
// // // // //   { patterns:["bye","goodbye","see you","take care","later","cya"], answer:"Goodbye! 👋 It was great chatting! Have a wonderful day! 😊" },
// // // // //   { patterns:["thank you","thanks","thankyou","thank u","ty","thx"], answer:"You're welcome! 😊 Happy to help anytime!" },
// // // // //   { patterns:["who made you","who created you","who built you"], answer:"I was created as a portfolio assistant for Thomas Jose! 🤖 Ask me anything about him!" },
// // // // //   { patterns:["are you a bot","are you human","are you ai","are you real"], answer:"I'm a portfolio chatbot for Thomas Jose! 🤖 I know all about his skills, projects, and experience!" },
// // // // //   { patterns:["what can you do","help me","what can i ask","what should i ask"], answer:"I can answer questions about Thomas Jose! 💡\n\n• 👨‍💻 Skills & Technologies\n• 💼 Work Experience\n• 🚀 Projects\n• 🎓 Education\n• 🏆 Certifications\n• 📬 Contact Information\n• 💪 Strengths & Philosophy" },
// // // // //   { patterns:["fun fact","interesting fact","tell me something interesting"], answer:"Thomas built an IoT Smart Pet Feeder that reduced feeding inconsistencies by 85%, and an Agriculture Robot boosting farming efficiency by 60%! 🌟" },
// // // // //   { patterns:["who are you","tell me about yourself","introduce yourself","about thomas","who is thomas"], answer:"Hi! I'm Thomas Jose's portfolio assistant 🤖\n\nThomas is a Web Developer at Webgeon Results, skilled in React, Next.js, and Tailwind CSS." },
// // // // //   { patterns:["professional summary","summary","bio","background","overview"], answer:"📋 Professional Summary\n\nThomas Jose is a Web Developer with 6 months at Webgeon Results, building responsive apps with React, Tailwind CSS & Next.js. Clean code, user-centric solutions, performance-focused." },
// // // // //   { patterns:["strengths","key strengths","qualities"], answer:"💪 Key Strengths\n\n• Decision-making & team leadership\n• Performance optimisation & accessibility\n• Clean, maintainable code\n• Timely delivery\n• Continuous learning\n• User experience focus" },
// // // // //   { patterns:["philosophy","approach","mindset","development philosophy"], answer:"💡 User-first mindset — ensuring technical excellence translates into intuitive, engaging user experiences." },
// // // // //   { patterns:["skills","technologies","tech stack","programming languages"], answer:"🛠️ Skills\n\n📌 Languages: Python 🐍, JavaScript ⚡, HTML 🌐, CSS 🎨\n⚛️ Frameworks: Next.js, React, Tailwind CSS\n🗄️ Databases: MongoDB, MySQL\n🔧 Tools: VS Code, Postman\n🤝 Soft Skills: Leadership, API Testing" },
// // // // //   { patterns:["react","nextjs","next.js","tailwind","frontend"], answer:"⚛️ Frontend: React, Next.js, Tailwind CSS — used daily at Webgeon Results for adaptive, high-performance UIs." },
// // // // //   { patterns:["database","mongodb","mysql","data"], answer:"🗄️ Databases: MongoDB (document-based) and MySQL (relational) — both applied at Webgeon Results." },
// // // // //   { patterns:["experience","work experience","job","webgeon","current job"], answer:"💼 Web Developer — Webgeon Results\n📅 Dec 2023 – Present\n\n• Built UIs with Next.js, Tailwind CSS & JS\n• Optimised performance & UX\n• API testing with Postman\n• MongoDB & MySQL data management\n• Leading Gym Management Software" },
// // // // //   { patterns:["internship","intern","nextgen","techmogul","embedded"], answer:"🎓 Internships\n\n1️⃣ Embedded Systems — Next Gen Pro (May 2023–2024)\nArduino, circuits, sensor automation\n\n2️⃣ Python Full Stack — TechMogul (Jun 2024)\nBlog app with Python, HTML, CSS, JS" },
// // // // //   { patterns:["education","college","degree","fisat","btech","cgpa","academic"], answer:"🎓 B.Tech — Electronics & Communication\n📍 FISAT, Kerala | 2021–2025 | CGPA: 7.45\n\n🏫 Senior Secondary (CBSE)\n📍 Vijayagiri Public School | Score: 87%" },
// // // // //   { patterns:["projects","what have you built","portfolio projects"], answer:"🚀 Featured Projects\n\n1. 🐾 Smart Pet Feeder – IoT automated feeding\n2. 🤖 Agriculture Robot – farming automation\n3. 🌍 Cross-Language Craft – translation app (Live)\n4. 💰 Financuz Nexus – finance dashboard (Live)\n5. ⌚ Chronos – luxury watch e-commerce (Live)" },
// // // // //   { patterns:["smart pet feeder","pet feeder","pet project"], answer:"🐾 Smart Pet Feeder\n📅 Aug 2023–Jan 2024\n\n• Automated scheduled food dispensing\n• Web dashboard for remote monitoring\n• 85% reduction in feeding inconsistencies\n\n🔗 github.com/Thomasjose-tech/Smart-Pet-Feeder" },
// // // // //   { patterns:["agriculture robot","farming robot","multipurpose"], answer:"🤖 Agriculture Robot\n📅 Mar 2024–Feb 2025\n\n• Soil monitoring, seed sowing & spraying\n• 60% efficiency gain, 45% labour cost reduction" },
// // // // //   { patterns:["cross language","translation","language craft"], answer:"🌍 Cross-Language Craft (2024)\n\n• Real-time multi-language translation\n• Responsive React app\n🔗 cross-language-craft-26011.vercel.app" },
// // // // //   { patterns:["financuz","finance","financial","budget","expense"], answer:"💰 Financuz Nexus (2024)\n\n• Financial dashboard & expense tracker\n• Budget planning tools\n🔗 financuz-nexus-01.vercel.app" },
// // // // //   { patterns:["chronos","watch","luxury","timepiece","ecommerce"], answer:"⌚ Chronos (2024)\n\n• Luxury watch e-commerce UI\n• Smooth animations & product filtering\n🔗 chronos-luxury-timepieces.vercel.app" },
// // // // //   { patterns:["certification","certificate","certifications","achievements"], answer:"🏆 Certifications\n\n1. Web Developer Intern — Webgeon Results\n2. Microsoft Azure Data Engineering — Coursera\n3. EF SET English C1 Advanced (66/100)\n4. TechMaghi Certificate 2024\n5. NextGen Pro Certificate 2024\n6. Microsoft Excel — Coursera\n7. CMOS Digital VLSI — NPTEL/IIT Roorkee" },
// // // // //   { patterns:["contact","email","phone","reach","hire","get in touch","connect","linkedin","github","whatsapp"], answer:"📬 Contact Thomas\n\n📧 thomasjose22@gmail.com\n📱 +91 8304909105\n💬 wa.me/918304909105\n🐙 github.com/Thomasjose-tech\n💼 linkedin.com/in/thomas-jose-98b97b220\n📍 Kerala, India" },
// // // // //   { patterns:["location","where are you","where do you live","kerala"], answer:"📍 Kerala, India — open to remote work & global collaboration!" },
// // // // //   { patterns:["gym","gym management","current project","ongoing"], answer:"🏋️ Gym Management Software (current)\n\n• Member tracking & payment history\n• Admin dashboards\n• Stack: Next.js, React, Tailwind, MongoDB" },
// // // // //   { patterns:["available","looking for job","open to work","freelance","opportunity"], answer:"✅ Open to:\n• Full-time Developer roles\n• Freelance projects\n• Remote collaborations\n\n📧 thomasjose22@gmail.com" },
// // // // //   { patterns:["hobby","hobbies","free time","interests","passion"], answer:"📚 Hobbies\n\n• 📖 Reading\n• 💻 Studying new technologies\n• 🌐 Web dev trends\n• 🤖 Building side projects" },
// // // // //   { patterns:["why should we hire you"], answer:"Clean code, performance focus, fast learner, team player who delivers on time. 🚀" },
// // // // //   { patterns:["what are your strengths","your strengths"], answer:"Problem-solving, performance optimisation, leadership, clean coding, continuous learning." },
// // // // //   { patterns:["what are your weaknesses","weakness"], answer:"I sometimes chase perfection, but I balance quality with deadlines effectively." },
// // // // //   { patterns:["why web development"], answer:"I love building interactive digital experiences that solve real-world problems." },
// // // // //   { patterns:["what is react","explain react"], answer:"React — JS library for reusable UI components with a virtual DOM." },
// // // // //   { patterns:["what is nextjs","explain nextjs"], answer:"Next.js — React framework with SSR, SSG, and API routes." },
// // // // //   { patterns:["difference react nextjs","react vs nextjs"], answer:"React is a UI library; Next.js is a full framework adding routing, SSR & optimization." },
// // // // //   { patterns:["what is tailwind","explain tailwind"], answer:"Tailwind CSS — utility-first CSS for rapid, responsive UI development." },
// // // // //   { patterns:["what is mongodb","explain mongodb"], answer:"MongoDB — NoSQL document database storing flexible JSON-like data." },
// // // // //   { patterns:["what is mysql","explain mysql"], answer:"MySQL — relational SQL database with structured tables." },
// // // // //   { patterns:["what is ssr","server side rendering"], answer:"SSR renders HTML on the server for better SEO and first-load performance." },
// // // // //   { patterns:["what is useeffect","useeffect hook"], answer:"useEffect — React hook for side effects like API calls and subscriptions." },
// // // // //   { patterns:["what is usestate","usestate hook"], answer:"useState — React hook to manage component-level state." },
// // // // //   { patterns:["what is rest api","rest api"], answer:"REST API — HTTP-based service using GET, POST, PUT, DELETE methods." },
// // // // //   { patterns:["how do you optimize performance","performance optimization"], answer:"Minimize re-renders, lazy load, optimize images, reduce API calls, memoize." },
// // // // //   { patterns:["future goals","career goals","where do you see yourself"], answer:"Become a senior developer leading scalable, impactful projects! 🚀" },
// // // // //   { patterns:["python","python language"], answer:"Python — used for scripting, automation, and full-stack dev. Thomas built a blog app with Python at TechMogul." },
// // // // //   { patterns:["salary","ctc","package","compensation"], answer:"Thomas is open to discussing compensation per role. 📧 thomasjose22@gmail.com" },
// // // // //   { patterns:["remote","work from home","wfh"], answer:"Yes! Thomas is open to remote work globally. 📍 Based in Kerala, India." },
// // // // //   { patterns:["english","english certificate"], answer:"EF SET English Certificate — C1 Advanced (66/100). Professional proficiency." },
// // // // // ];

// // // // // // ── Smart Matching ─────────────────────────────────────────────────
// // // // // const STOP = new Set(["a","an","the","is","are","was","were","be","been","have","has","do","does","did","will","would","could","should","may","might","i","my","me","you","your","we","our","they","their","it","its","this","that","of","in","on","at","to","for","with","by","from","about","as","or","and","but","not","no","so","if","then","than","also","what","how","why","when","where","who","tell","explain","describe","give","show","any","some","please","know","need","want","more","there","here","which","very","just","much","many","really","can","little","bit","help","info","information","details"]);
// // // // // const tokenize = (t:string) => t.toLowerCase().replace(/[^a-z0-9\s.+#]/g," ").split(/\s+/).filter(w=>w.length>1&&!STOP.has(w));
// // // // // const KB_IDX = KB.map((e,i)=>{const s=new Set<string>();e.patterns.forEach(p=>tokenize(p).forEach(t=>s.add(t)));return{i,s,p:e.patterns};});

// // // // // function getBotResponse(input:string):string {
// // // // //   const q = input.toLowerCase().trim();
// // // // //   for(const e of KB) for(const p of e.patterns) if(q.includes(p)||p.includes(q)) return e.answer;
// // // // //   const ut = tokenize(input);
// // // // //   if(!ut.length) return "Could you rephrase that? 😊 Ask about skills, projects, or contact info!";
// // // // //   let best:string|null=null, top=0;
// // // // //   for(const {i,s,p} of KB_IDX){
// // // // //     let sc=0,pb=0;
// // // // //     for(const t of ut){if(s.has(t))sc+=2;for(const k of s)if(k!==t&&(k.includes(t)||t.includes(k))&&t.length>2)sc+=1;}
// // // // //     for(const pat of p){const pt=tokenize(pat);const m=pt.filter(t=>ut.includes(t)).length;if(pt.length&&m/pt.length>=0.6)pb=Math.max(pb,3);}
// // // // //     if(sc+pb>top){top=sc+pb;best=KB[i].answer;}
// // // // //   }
// // // // //   if(top>=2&&best)return best;
// // // // //   return "🤔 I'm not sure about that!\n\nTry asking about:\n• Skills & Technologies\n• Work Experience\n• Projects\n• Education\n• Contact Info";
// // // // // }
...
// // // // //   const [h,setH]=useState(()=>typeof window!=="undefined"?window.innerHeight:700);
// // // // //   useEffect(()=>{const vv=(window as any).visualViewport;if(!vv)return;const fn=()=>setH(vv.height);vv.addEventListener("resize",fn);vv.addEventListener("scroll",fn);return()=>{vv.removeEventListener("resize",fn);vv.removeEventListener("scroll",fn);};},[]);
// // // // //   return h;
// // // // // }
// // // // // function useMobile(){
...
// // // // // type SizeMode = "mini"|"half"|"full"; // mini=popup, half=50%, full=fullscreen
...
// // // // //   // ── State ──
// // // // //   const [open,     setOpen]     = useState(false);
// // // // //   const [mode,     setMode]     = useState<SizeMode>("mini");
// // // // //   const [msgs,     setMsgs]     = useState<Msg[]>([{
// // // // //     id:0, role:"bot",
// // // // //     text:"👋 Hi! I'm Thomas's portfolio assistant.\n\nAsk me anything about his skills, projects, experience, or contact info!",
// // // // //     time: new Date().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),
// // // // //   }]);
// // // // //   const [input,    setInput]    = useState("");
// // // // //   const [typing,   setTyping]   = useState(false);
// // // // //   const [badge,    setBadge]    = useState(true);  // "Ask me" tooltip
// // // // //   const [unread,   setUnread]   = useState(0);     // unread count when closed
// // // // //   const [copied,   setCopied]   = useState<number|null>(null); // copied msg id
// // // // //   const [dragging, setDragging] = useState(false); // drag-handle active
// // // // //   const [halfH,    setHalfH]    = useState(0);     // custom half height from drag
...
// // // // //   // ── Init halfH from viewport ──
// // // // //   useEffect(()=>{ setHalfH(Math.round(vh*0.55)); },[vh]);
...
// // // // //   useEffect(()=>{
// // // // //     if(open){ setTimeout(()=>inputRef.current?.focus(),350); setBadge(false); setUnread(0); }
// // // // //   },[open]);

// // // // //   // ── Escape key ──
// // // // //   useEffect(()=>{
// // // // //     const fn=(e:KeyboardEvent)=>{ if(e.key==="Escape"&&open){ if(mode==="full")setMode("half"); else if(mode==="half")setMode("mini"); else setOpen(false); } };
...
// // // // //     if(!t)return;
// // // // //     const time=new Date().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"});
// // // // //     setMsgs(p=>[...p,{id:Date.now(),role:"user",text:t,time}]);
// // // // //     setInput("");
// // // // //     setTyping(true);
// // // // //     setTimeout(()=>{
// // // // //       const reply = getBotResponse(t);
// // // // //       setMsgs(p=>[...p,{id:Date.now()+1,role:"bot",text:reply,time}]);
// // // // //       setTyping(false);
...
// // // // //       text:"🗑️ Chat cleared! Feel free to ask me anything about Thomas.",
// // // // //       time: new Date().toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),
// // // // //     }]);
// // // // //   };
...
// // // // //   // ── Mode cycling ──
// // // // //   const nextMode = ()=>{
// // // // //     if(mode==="mini") setMode("half");
// // // // //     else if(mode==="half") setMode("full");
// // // // //     else setMode("mini");
// // // // //   };
// // // // //   const shrinkMode = ()=>{
// // // // //     if(mode==="full") setMode("half");
// // // // //     else if(mode==="half") setMode("mini");
// // // // //     else setOpen(false);
// // // // //   };

// // // // //   // ── Drag handle (resize half-mode height) ──
// // // // //   const onDragStart = (e:React.PointerEvent)=>{
// // // // //     setDragging(true);
// // // // //     dragStartY.current = e.clientY;
// // // // //     dragStartH.current = halfH;
// // // // //     (e.target as HTMLElement).setPointerCapture(e.pointerId);
// // // // //   };
// // // // //   const onDragMove = (e:React.PointerEvent)=>{
// // // // //     if(!dragging)return;
// // // // //     const delta = dragStartY.current - e.clientY;
// // // // //     const newH  = Math.min(Math.max(dragStartH.current+delta, 280), vh-60);
// // // // //     setHalfH(newH);
// // // // //     // Snap to full if dragged to top 15%
// // // // //     if(newH > vh*0.85) setMode("full");
// // // // //   };
// // // // //   const onDragEnd = ()=>setDragging(false);

// // // // //   // ── Theme colours ──
// // // // //   const c = {
// // // // //     bg:          dark?"rgba(13,17,30,0.98)":"rgba(255,255,255,0.98)",
// // // // //     border:      dark?"#1e293b":"rgba(200,210,255,0.45)",
// // // // //     shadow:      dark?"0 30px 70px rgba(0,0,0,0.8),0 0 0 1px rgba(99,102,241,0.2)":"0 30px 70px rgba(0,0,0,0.18),0 0 0 1px rgba(99,102,241,0.1)",
// // // // //     msgArea:     dark?"linear-gradient(160deg,#0a0f1e 0%,#111827 100%)":"linear-gradient(160deg,#f8faff 0%,#f1f4fb 100%)",
// // // // //     botBg:       dark?"#161d2e":"#ffffff",
// // // // //     botTxt:      dark?"#e2e8f0":"#1f2937",
// // // // //     botBdr:      dark?"1px solid #253047":"1px solid #e8ecf5",
// // // // //     timeTxt:     dark?"#4b6080":"#9ca3af",
// // // // //     chipBg:      dark?"rgba(30,41,59,0.8)":"rgba(238,242,255,0.9)",
// // // // //     chipBdr:     dark?"#2a3d5c":"#c7d7fe",
// // // // //     chipTxt:     dark?"#93c5fd":"#3b5bdb",
// // // // //     inputAreaBg: dark?"rgba(10,14,26,0.95)":"rgba(250,251,255,0.95)",
// // // // //     inputBg:     dark?"#141c2f":"#f4f6ff",
// // // // //     inputBdr:    dark?"#253047":"#dde3f5",
// // // // //     inputTxt:    dark?"#e2e8f0":"#111827",
// // // // //     dragHandle:  dark?"#2d3d58":"#d0d8f0",
// // // // //     overlayBg:   dark?"rgba(0,0,0,0.7)":"rgba(30,30,60,0.35)",
// // // // //     headerGrad:  "linear-gradient(135deg,#3b82f6 0%,#8b5cf6 100%)",
// // // // //   };
...
// // // // //       background:c.bg, zIndex:9000,
// // // // //       transition: dragging ? "none" : "all 0.35s cubic-bezier(0.34,1.1,0.64,1)",
// // // // //     };

// // // // //     if(mob){
// // // // //       // Mobile: always a bottom sheet, height controlled by mode
// // // // //       const modeH: Record<SizeMode,string> = {
// // // // //         mini:  `${Math.min(68, Math.round(vh*0.65/10)*10)}vh`,
// // // // //         half:  `${halfH}px`,
// // // // //         full:  `${vh}px`,
// // // // //       };
// // // // //       return {
...
// // // // //         height: mode==="half" ? `${halfH}px` : modeH[mode],
// // // // //         borderRadius: mode==="full" ? 0 : "20px 20px 0 0",
// // // // //         border: mode==="full" ? "none" : `1px solid ${c.border}`,
...
// // // // //     // Desktop
// // // // //     if(mode==="full"){
// // // // //       return {...base, inset:0, width:"100vw", height:"100vh", borderRadius:0, border:"none", boxShadow:"none"};
// // // // //     }
// // // // //     if(mode==="half"){
// // // // //       return {
// // // // //         ...base,
// // // // //         top:0, right:0, bottom:0, width:"min(480px,48vw)",
...
// // // // //   // ── Mode icon helper ──
// // // // //   const ModeIcon = ()=>{
// // // // //     if(mode==="mini")  return <PanelRightOpen size={14} color="white" />;
// // // // //     if(mode==="half")  return <Maximize2 size={14} color="white" />;
// // // // //     return                    <Minimize2 size={14} color="white" />;
// // // // //   };
// // // // //   const modeLabel = ()=>{
// // // // //     if(mode==="mini")  return mob ? "Expand" : "Half screen";
...
// // // // //   return (
// // // // //     <>
// // // // //       {/* Overlay — half/full desktop, full mobile */}
// // // // //       {open && (mode==="full"||(mode==="half"&&!mob)) && (
// // // // //         <div
// // // // //           style={{position:"fixed",inset:0,zIndex:8999,background:c.overlayBg,backdropFilter:"blur(2px)"}}
// // // // //           onClick={()=>{ if(mode==="full")setMode("half"); else setOpen(false); }}
// // // // //         />
// // // // //       )}

// // // // //       {/* ── Launcher button ─────────────────────────────────────────
// // // // //           Hidden on mobile when chat is open (window covers screen)
// // // // //       ── */}
// // // // //       {!(mob && open) && (
// // // // //         <div className="fixed z-50" style={{bottom:"5.5rem",right:"1.5rem"}}>
// // // // //           {/* Ask-me tooltip */}
...
// // // // //             <div
// // // // //               onClick={()=>setOpen(true)}
// // // // //               className="absolute text-sm px-4 py-2 rounded-2xl shadow-lg cursor-pointer select-none whitespace-nowrap"
// // // // //               style={{
// // // // //                 bottom:"100%", right:0, marginBottom:"0.5rem",
// // // // //                 animation:"fadeSlideIn 0.5s ease forwards",
// // // // //                 background:c.bg, color:dark?"#e2e8f0":"#374151",
// // // // //                 border:`1px solid ${c.border}`,
// // // // //               }}
// // // // //             >
// // // // //               💬 Ask me anything!
...
// // // // //               style={{background:"#ef4444", animation:"badgePop 0.3s ease"}}
// // // // //             >
// // // // //               {unread}
// // // // //             </span>
// // // // //           )}
...
// // // // //             onClick={()=>setOpen(v=>!v)}
// // // // //             aria-label="Toggle chatbot"
// // // // //             className="w-14 h-14 rounded-full overflow-hidden shadow-2xl transition-all duration-300 hover:scale-110 active:scale-95 ring-2 ring-primary/30 hover:ring-primary/60"
// // // // //           >
// // // // //             <img src="/assets/certificates/photo.jpg" alt="Chatbot" className="w-full h-full object-cover object-[50%_25%] rounded-full" />
// // // // //           </button>
// // // // //         </div>
// // // // //       )}
...
// // // // //           {/* Drag handle — mobile half mode only */}
// // // // //           {mob && mode!=="full" && (
// // // // //             <div
// // // // //               className="flex-shrink-0 flex justify-center items-center py-2 cursor-grab active:cursor-grabbing touch-none"
// // // // //               style={{background:c.bg}}
// // // // //               onPointerDown={onDragStart}
// // // // //               onPointerMove={onDragMove}
// // // // //               onPointerUp={onDragEnd}
// // // // //             >
// // // // //               <div className="w-10 h-1.5 rounded-full" style={{background:c.dragHandle}} />
// // // // //             </div>
// // // // //           )}
...
// // // // //             <div className="relative flex-shrink-0">
// // // // //               <img
// // // // //                 src="/assets/certificates/photo.jpg" alt="Thomas Jose"
// // // // //                 className="w-10 h-10 rounded-full object-cover object-top border-2 border-white/40"
...
// // // // //             <div className="flex-1 min-w-0">
// // // // //               <div className="font-semibold text-white text-sm leading-tight">Portfolio Assistant</div>
// // // // //               <div className="text-white/65 text-xs">Online · Thomas Jose</div>
// // // // //             </div>
...
// // // // //               {/* Mode cycle button with label tooltip */}
// // // // //               <button
// // // // //                 onClick={nextMode}
// // // // //                 title={modeLabel()}
// // // // //                 className="w-7 h-7 rounded-full bg-white/10 hover:bg-white/25 flex items-center justify-center transition-colors"
...
// // // // //               <button
// // // // //                 onClick={shrinkMode}
// // // // //                 title={mode==="mini" ? "Close" : "Shrink"}
// // // // //                 className="w-7 h-7 rounded-full bg-white/10 hover:bg-red-400/70 flex items-center justify-center transition-colors"
// // // // //               >
// // // // //                 {mode==="mini" ? <X size={14} color="white" /> : <ChevronDown size={16} color="white" />}
// // // // //               </button>
// // // // //             </div>
// // // // //           </div>

// // // // //           {/* ── Size mode indicator pills (below header) ── */}
// // // // //           <div
// // // // //             className="flex justify-center gap-1.5 py-1.5 flex-shrink-0"
// // // // //             style={{background:dark?"rgba(10,14,26,0.6)":"rgba(240,244,255,0.8)", borderBottom:`1px solid ${c.border}`}}
// // // // //           >
// // // // //             {(["mini","half","full"] as SizeMode[]).map(m=>(
// // // // //               <button
// // // // //                 key={m}
// // // // //                 onClick={()=>setMode(m)}
// // // // //                 title={m==="mini"?"Popup":m==="half"?"Half screen":"Fullscreen"}
// // // // //                 className="flex items-center gap-1 px-2 py-0.5 rounded-full text-xs transition-all duration-200"
// // // // //                 style={{
// // // // //                   background: mode===m ? "linear-gradient(135deg,#3b82f6,#8b5cf6)" : dark?"rgba(255,255,255,0.06)":"rgba(0,0,0,0.05)",
// // // // //                   color: mode===m ? "white" : dark?"#64748b":"#94a3b8",
// // // // //                   transform: mode===m ? "scale(1.05)" : "scale(1)",
// // // // //                 }}
// // // // //               >
// // // // //                 {m==="mini"  && <Square size={9} />}
// // // // //                 {m==="half"  && <PanelRightOpen size={9} />}
// // // // //                 {m==="full"  && <Maximize2 size={9} />}
// // // // //                 <span className="capitalize hidden sm:inline">{m==="mini"?"Popup":m==="half"?"Half":"Full"}</span>
// // // // //               </button>
// // // // //             ))}
// // // // //           </div>
...
// // // // //           {/* ── Messages area ─────────────────────────────────────── */}
// // // // //           <div
// // // // //             className="chat-messages flex-1 overflow-y-auto py-4 px-4 space-y-4"
// // // // //             style={{background:c.msgArea, overscrollBehavior:"contain"}}
// // // // //           >
// // // // //             {msgs.map(msg=>(
// // // // //               <div
// // // // //                 key={msg.id}
// // // // //                 className="msg-wrapper flex items-end gap-2"
// // // // //                 style={{flexDirection:msg.role==="user"?"row-reverse":"row", animation:"fadeSlideIn 0.3s ease forwards"}}
// // // // //               >
// // // // //                 {/* Avatar */}
// // // // //                 <div
// // // // //                   className="flex-shrink-0 w-7 h-7 rounded-full overflow-hidden flex items-center justify-center"
...
// // // // //                   {msg.role==="bot" ? (
// // // // //                     <>
// // // // //                       <img src="/assets/certificates/photo.jpg" alt="Thomas" className="w-full h-full object-cover object-[50%_25%] rounded-full" onError={e=>{e.currentTarget.style.display="none";(e.currentTarget.nextSibling as HTMLElement).style.display="flex";}} />
// // // // //                       <div className="w-7 h-7 items-center justify-center" style={{display:"none"}}><Bot size={14} color="white" /></div>
// // // // //                     </>
// // // // //                   ) : (
// // // // //                     <div className="w-7 h-7 rounded-full flex items-center justify-center" style={{background:"linear-gradient(135deg,#10b981,#059669)"}}>
// // // // //                       <User size={14} color="white" />
...
// // // // //                 {/* Bubble + copy */}
// // // // //                 <div style={{maxWidth: mode==="full"?"60%":"80%"}}>
// // // // //                   <div className="relative group">
// // // // //                     <div
// // // // //                       className="text-sm px-3.5 py-2.5 rounded-2xl whitespace-pre-wrap leading-relaxed"
// // // // //                       style={msg.role==="bot"
// // // // //                         ? {background:c.botBg,color:c.botTxt,border:c.botBdr,borderBottomLeftRadius:"4px",boxShadow:"0 1px 4px rgba(0,0,0,0.07)"}
// // // // //                         : {background:"linear-gradient(135deg,#3b82f6,#8b5cf6)",color:"white",borderBottomRightRadius:"4px"}}
// // // // //                     >
// // // // //                       {msg.text}
// // // // //                     </div>
...
// // // // //                       className="msg-copy-btn absolute -top-1 rounded-full p-1 transition-all"
// // // // //                       style={{
// // // // //                         [msg.role==="bot"?"right":"left"]:"-8px",
// // // // //                         background:dark?"#1e293b":"#e8ecf8",
// // // // //                         border:`1px solid ${c.border}`,
// // // // //                       }}
// // // // //                       title="Copy"
// // // // //                     >
...
// // // // //                         : <Copy size={10} color={dark?"#64748b":"#94a3b8"} />}
// // // // //                     </button>
// // // // //                   </div>
// // // // //                   <div className="text-xs mt-1 px-1" style={{color:c.timeTxt,textAlign:msg.role==="user"?"right":"left"}}>
// // // // //                     {msg.time}
...
// // // // //                   <img src="/assets/certificates/photo.jpg" alt="Thomas" className="w-full h-full object-cover object-[50%_25%] rounded-full" onError={e=>{e.currentTarget.style.display="none";}} />
// // // // //                 </div>
// // // // //                 <div className="px-4 py-3 rounded-2xl flex gap-1 items-center" style={{background:c.botBg,border:c.botBdr,borderBottomLeftRadius:"4px"}}>
// // // // //                   {[0,1,2].map(i=>(
// // // // //                     <span key={i} className="w-2 h-2 rounded-full inline-block" style={{background:"#94a3b8",animation:`typingDot 1.2s ease-in-out ${i*0.2}s infinite`}} />
// // // // //                   ))}
// // // // //                 </div>
...
// // // // //           <div
// // // // //             className="flex gap-2 px-3 py-2 overflow-x-auto flex-shrink-0"
// // // // //             style={{background:dark?"rgba(8,12,24,0.9)":"rgba(245,247,255,0.95)",borderTop:`1px solid ${c.border}`,scrollbarWidth:"none"}}
// // // // //           >
// // // // //             {SUGGESTIONS.map(s=>(
// // // // //               <button
// // // // //                 key={s}
// // // // //                 onClick={()=>send(s)}
// // // // //                 className="flex-shrink-0 text-xs px-3 py-1.5 rounded-full whitespace-nowrap font-medium transition-all duration-200 hover:scale-105 active:scale-95"
// // // // //                 style={{background:c.chipBg,border:`1px solid ${c.chipBdr}`,color:c.chipTxt}}
// // // // //               >
// // // // //                 {s}
// // // // //               </button>
// // // // //             ))}
...
// // // // //           <div
// // // // //             className="flex items-center gap-2 px-3 py-3 flex-shrink-0"
// // // // //             style={{background:c.inputAreaBg,borderTop:`1px solid ${c.border}`}}
// // // // //           >
// // // // //             <input
// // // // //               ref={inputRef}
// // // // //               value={input}
...
// // // // //               onKeyDown={e=>{if(e.key==="Enter"&&!e.shiftKey){e.preventDefault();send(input);}}}
// // // // //               placeholder="Ask me anything..."
// // // // //               className="flex-1 rounded-xl px-3.5 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
// // // // //               style={{
// // // // //                 background:c.inputBg, border:`1px solid ${c.inputBdr}`,
// // // // //                 color:c.inputTxt, fontSize:"16px",  // prevents iOS zoom
// // // // //               } as React.CSSProperties}
// // // // //             />
// // // // //             <button
// // // // //               onClick={()=>send(input)}
// // // // //               disabled={!input.trim()}
// // // // //               className="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0 transition-all duration-200 hover:scale-110 active:scale-95 disabled:opacity-35 disabled:cursor-not-allowed disabled:hover:scale-100"
// // // // //               style={{background:input.trim()?"linear-gradient(135deg,#3b82f6,#8b5cf6)":dark?"#1e293b":"#e5e7eb"}}
// // // // //             >
// // // // //               <Send size={15} color={input.trim()?"white":"#94a3b8"} />
// // // // //             </button>
// // // // //           </div>
...
// // // // //   const handleSubmit = (e:React.FormEvent) => {
// // // // //     e.preventDefault();
// // // // //     const sub = encodeURIComponent(formData.subject||"Contact Form Message");
// // // // //     const body = encodeURIComponent(`Hello Thomas,\n\nName: ${formData.name}\nEmail: ${formData.email}\n\nMessage:\n${formData.message}\n\nBest regards,\n${formData.name}`);
// // // // //     window.location.href=`mailto:thomasjose22@gmail.com?subject=${sub}&body=${body}`;
// // // // //     toast({title:"Opening Email Client",description:"Your email client will open with the message pre-filled."});
// // // // //   };
// // // // //   const handleChange = (e:React.ChangeEvent<HTMLInputElement|HTMLTextAreaElement>) => {
...
// // // // //                     <div className="font-medium text-foreground group-hover:text-primary transition-colors">{c.value}</div>
// // // // //                   </div>
// // // // //                 </a>
// // // // //               ))}
// // // // //             </div>
...
// // // // //         <div className={`text-center mt-16 pt-8 border-t border-border transition-opacity duration-300 ${isVisible?"animate-fade-up":"opacity-0"}`} style={{animationDelay:isVisible?"0.7s":"0s"}} />
// // // // //       </div>

// // // // //       {/* WhatsApp */}
// // // // //       <a href="https://wa.me/918304909105" target="_blank" rel="noopener noreferrer"
// // // // //         className="fixed bottom-6 right-6 bg-white hover:bg-gray-50 p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 z-50"
// // // // //         title="Chat on WhatsApp"
// // // // //       >
// // // // //         <img src="/lovable-uploads/WhatsApp-icone.png" alt="WhatsApp" className="w-8 h-8" />
...
// // // //   Mail, Phone, Github, Linkedin, MapPin, Send, X, Bot, User,
// // // //   Minimize2, Maximize2, Copy, Check, Trash2, ChevronDown,
// // // //   PanelRightOpen, Square, MessageCircle
// // // // } from "lucide-react";
// // // // import { useState, useEffect, useRef, useCallback } from "react";
// // // // import { useToast } from "@/hooks/use-toast";
...
// // // // /* ── Radial launcher animations ── */
// // // // @keyframes tabPulse {
// // // //   0%,100% { box-shadow:0 0 8px rgba(99,102,241,0.55); }
// // // //   50%     { box-shadow:0 0 18px rgba(99,102,241,0.95),0 0 28px rgba(139,92,246,0.5); }
// // // // }
// // // // @keyframes hubSpinIn {
...
// // // //   from { transform:scale(0.35) rotate(-90deg); opacity:0; }
// // // //   to   { transform:scale(1) rotate(0deg);      opacity:1; }
// // // // }
// // // // @keyframes itemSpinIn {
// // // //   from { transform:translate(0,0) scale(0) rotate(-270deg); opacity:0; }
// // // //   to   { transform:translate(var(--tx),var(--ty)) scale(1) rotate(0deg); opacity:1; }
// // // // }
...
// // // // // ── Types ──────────────────────────────────────────────────────────
// // // // interface Msg { id:number; role:"user"|"bot"; text:string; time:string; }
// // // // type SizeMode = "mini"|"half"|"full";

// // // // // ══════════════════════════════════════════════════════════════════
// // // // // RadialLauncher — edge line that blooms into a circular dial
// // // // // ══════════════════════════════════════════════════════════════════
...
// // // //   { id:"chat",     angleDeg:-150, label:"Chat",     bg:"linear-gradient(135deg,#3b82f6,#8b5cf6)", action:"chat" },
// // // //   { id:"whatsapp", angleDeg:-90,  label:"WhatsApp", bg:"#25D366", action:"whatsapp", href:"https://wa.me/918304909105" },
// // // // ];

// // // // const RadialLauncher = ({
// // // //   dark, chatOpen, onOpenChat,
// // // // }:{
// // // //   dark:boolean; chatOpen:boolean; onOpenChat:()=>void;
// // // // }) => {
// // // //   const [bloomed, setBloomed] = useState(false);

// // // //   // Collapse if chat opens
// // // //   useEffect(()=>{ if(chatOpen) setBloomed(false); },[chatOpen]);

// // // //   // Escape closes the dial
// // // //   useEffect(()=>{
// // // //     const fn=(e:KeyboardEvent)=>{ if(e.key==="Escape") setBloomed(false); };
// // // //     window.addEventListener("keydown",fn);
// // // //     return()=>window.removeEventListener("keydown",fn);
// // // //   },[]);
...
// // // //   const handleItem = (it:RadialItem)=>{
// // // //     setBloomed(false);
// // // //     if(it.action==="chat") onOpenChat();
...
// // // //           style={{background:dark?"rgba(0,0,0,0.35)":"rgba(20,25,50,0.18)",backdropFilter:"blur(1.5px)"}}
...
// // // //         style={{ top:"50%", right:"0.9rem", transform:"translateY(-50%)" }}
// // // //       >
// // // //         {/* Orbiting items */}
// // // //         {bloomed && (
// // // //           <div
...
// // // //                 border:`1px solid ${dark?"rgba(148,163,184,0.22)":"rgba(100,116,139,0.18)"}`,
// // // //                 background:dark?"rgba(15,23,42,0.5)":"rgba(255,255,255,0.55)",
// // // //                 backdropFilter:"blur(8px)",
// // // //                 boxShadow:dark?"inset 0 0 30px rgba(59,130,246,0.08)":"inset 0 0 30px rgba(99,102,241,0.06)",
// // // //                 animation:"ringFadeIn 0.4s cubic-bezier(0.34,1.4,0.64,1) forwards",
// // // //               }}
// // // //             />
// // // //             {/* Accent arc, echoes the highlighted segment in the reference dial */}
// // // //             <svg
// // // //               viewBox="0 0 200 200"
// // // //               style={{position:"absolute",inset:0,width:"100%",height:"100%",animation:"ringFadeIn 0.5s ease forwards"}}
// // // //             >
// // // //               <circle
// // // //                 cx="100" cy="100" r="96" fill="none"
// // // //                 stroke="url(#radGrad)" strokeWidth="2.5" strokeLinecap="round"
// // // //                 strokeDasharray="150 453" strokeDashoffset="38"
...
// // // //               const {x,y} = polar(it.angleDeg, RADIUS);
// // // //               return (
// // // //                 <div
// // // //                   key={it.id}
// // // //                   className="absolute"
// // // //                   style={{
// // // //                     top:"50%", left:"50%",
// // // //                     marginTop:-ITEM/2, marginLeft:-ITEM/2,
// // // //                     width:ITEM, height:ITEM,
// // // //                     ["--tx" as any]:`${x}px`,
// // // //                     ["--ty" as any]:`${y}px`,
// // // //                     animation:"itemSpinIn 0.5s cubic-bezier(0.34,1.45,0.64,1) forwards",
...
// // // //                     aria-label={it.label}
// // // //                     className="w-full h-full rounded-full flex items-center justify-center shadow-xl transition-transform duration-200 hover:scale-110 active:scale-95"
// // // //                     style={{background:it.bg, border:"2px solid rgba(255,255,255,0.35)"}}
// // // //                   >
// // // //                     {it.action==="chat"
// // // //                       ? <MessageCircle size={21} color="white" />
// // // //                       : <img src="/lovable-uploads/WhatsApp-icone.png" alt="WhatsApp" style={{width:22,height:22}} />}
// // // //                   </button>
// // // //                   <span
// // // //                     className="absolute text-[10px] font-medium whitespace-nowrap px-1.5 py-0.5 rounded-md"
// // // //                     style={{
// // // //                       top:"100%", left:"50%", transform:"translateX(-50%)", marginTop:4,
// // // //                       background:dark?"rgba(15,23,42,0.85)":"rgba(255,255,255,0.9)",
// // // //                       color:dark?"#cbd5e1":"#475569",
// // // //                       animation:"labelFadeIn 0.4s ease 0.25s both",
// // // //                     }}
// // // //                   >
// // // //                     {it.label}
// // // //                   </span>
...
// // // //         {/* Hub / collapsed edge line */}
// // // //         {!bloomed ? (
// // // //           <button
// // // //             onClick={()=>setBloomed(true)}
// // // //             aria-label="Open quick actions"
// // // //             className="block rounded-full transition-transform duration-200 active:scale-90"
// // // //             style={{
...
// // // //               animation:"hubSpinIn 0.42s cubic-bezier(0.34,1.45,0.64,1) forwards",
// // // //             }}
// // // //           >
// // // //             <span className="absolute inset-0 rounded-full" style={{boxShadow:"0 0 0 6px rgba(99,102,241,0.12)"}} />
// // // //             <X size={22} color={dark?"#93c5fd":"#6366f1"} />
// // // //           </button>
// // // //         )}
// // // //       </div>
// // // //     </>
...
// // // //       {open && (mode==="full"||(mode==="half"&&!mob)) && (
// // // //         <div
// // // //           style={{position:"fixed",inset:0,zIndex:9150,background:c.overlayBg,backdropFilter:"blur(2px)"}}
// // // //           onClick={()=>{ if(mode==="full")setMode("half"); else setOpen(false); }}
// // // //         />
// // // //       )}

// // // //       {/* ── DESKTOP launcher (unchanged behaviour) ── */}
// // // //       {!mob && (
// // // //         <div className="fixed z-50" style={{bottom:"5.5rem",right:"1.5rem"}}>
// // // //           {!open && badge && (
// // // //             <div
...
// // // //               style={{
// // // //                 background:c.inputBg, border:`1px solid ${c.inputBdr}`,
// // // //                 color:c.inputTxt, fontSize:"16px",
// // // //               } as React.CSSProperties}
// // // //             />
// // // //             <button
// // // //               onClick={()=>send(input)}
...
// // // //       {/* WhatsApp — desktop only (mobile uses the radial dial) */}
// // // //       {!mob && (
// // // //         <a href="https://wa.me/918304909105" target="_blank" rel="noopener noreferrer"
// // // //           className="fixed bottom-6 right-6 bg-white hover:bg-gray-50 p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 z-50"
// // // //           title="Chat on WhatsApp"
...
// // // // ── Avatar ─────────────────────────────────────────────────────────
// // // // CHANGE THIS ONE LINE if your photo lives elsewhere.
// // // // The file must sit in the PUBLIC folder, e.g.  public/assets/certificates/photo.jpg
// // // // Then this path (starting with "/") resolves correctly in dev AND after build.
// // // const AVATAR_SRC = "/assets/certificates/photo.jpg";

// // // /** Photo with a guaranteed fallback — never renders a broken image. */
// // // const Avatar = ({ size, iconSize }:{ size:number; iconSize:number }) => {
// // //   const [failed, setFailed] = useState(false);
// // //   if (failed) {
// // //     return (
// // //       <div
// // //         className="rounded-full flex items-center justify-center"
// // //         style={{ width:size, height:size, background:"linear-gradient(135deg,#3b82f6,#8b5cf6)" }}
// // //       >
...
// // //             /* 44x80 invisible hit area so the thin line is actually tappable */
// // //             style={{ width:"44px", height:"80px", background:"transparent", padding:0, border:"none" }}
// // //           >
// // //             <span
...
// // }
// // /* item entrance is scale/opacity only — position is handled by the
// //    outer positioner so the dial can be dragged while items sit still */
// // @keyframes itemPop {
// //   from { transform:scale(0) rotate(-270deg); opacity:0; }
// //   to   { transform:scale(1) rotate(0deg);    opacity:1; }
// // }
// // @keyframes labelFadeIn {
// //   from { opacity:0; transform:translateX(6px); }
...
// // // ══════════════════════════════════════════════════════════════════
// // // RadialLauncher — edge line that blooms into a draggable circular dial
// // // Items: Chat (your photo), WhatsApp, Email, Call
// // // ══════════════════════════════════════════════════════════════════
// // interface RadialItem {
// //   id: string;
// //   angleDeg: number;             // resting angle on the dial
// //   label: string;
// //   bg: string;
// //   action: "chat" | "link";
// //   href?: string;
...
// // /** Angles are in screen space: -90 = up, 180 = left, 90 = down.
// //  *  All four sit on the LEFT arc because the hub hugs the right edge. */
// // const RADIAL_ITEMS: RadialItem[] = [
// //   { id:"chat",     angleDeg:-120, label:"Chat",     bg:"linear-gradient(135deg,#3b82f6,#8b5cf6)", action:"chat" },
// //   { id:"whatsapp", angleDeg:-160, label:"WhatsApp", bg:"#25D366", action:"link", href:"https://wa.me/918304909105", newTab:true },
// //   { id:"email",    angleDeg:-200, label:"Email",    bg:"linear-gradient(135deg,#f97316,#ef4444)", action:"link", href:"mailto:thomasjose22@gmail.com" },
// //   { id:"phone",    angleDeg:-240, label:"Call",     bg:"linear-gradient(135deg,#10b981,#059669)", action:"link", href:"tel:+918304909105" },
// // ];

// // const MAX_ROT = 36;   // how far the dial can be spun either way
...
// // }) => {
// //   const [bloomed, setBloomed] = useState(false);
// //   const [rot,     setRot]     = useState(0);     // dial rotation in degrees
...
// //   // Collapse if chat opens
// //   useEffect(()=>{ if(chatOpen){ setBloomed(false); setRot(0); } },[chatOpen]);
...
// //   // ── rotation drag (listeners live on window so buttons keep their taps) ──
...
// //       let d = pointerAngle(e.clientX,e.clientY) - startAngle.current;
// //       if(d >  180) d -= 360;
// //       if(d < -180) d += 360;
// //       if(Math.abs(d) > 4) suppressTap.current = true;   // it's a spin, not a tap
// //       setRot(clamp(startRot.current + d, -MAX_ROT, MAX_ROT));
// //       e.preventDefault();
// //     };
// //     const up = ()=>{
// //       setSpinning(false);
// //       window.setTimeout(()=>{ suppressTap.current = false; },160);
// //     };
...
// //     };
// //   },[spinning,pointerAngle]);

// //   const beginSpin = (e:React.PointerEvent)=>{
// //     startAngle.current = pointerAngle(e.clientX,e.clientY);
...
// //   const handleItem = (it:RadialItem)=>{
// //     if(suppressTap.current) return;          // ignore the tap that ended a spin
// //     setBloomed(false);
// //     if(it.action==="chat"){ onOpenChat(); return; }
// //     if(!it.href) return;
// //     if(it.newTab) window.open(it.href,"_blank","noopener,noreferrer");
...
// //             {/* Accent arc — turns with the dial so the spin is readable */}
// //             <svg
// //               viewBox="0 0 200 200"
// //               style={{
// //                 position:"absolute", inset:0, width:"100%", height:"100%",
// //                 transform:`rotate(${rot}deg)`,
// //                 transition: spinning ? "none" : "transform 0.35s cubic-bezier(0.34,1.2,0.64,1)",
// //                 pointerEvents:"none",
// //               }}
// //             >
// //               <circle
...
// //             {RADIAL_ITEMS.map((it,i)=>{
// //               const {x,y} = polar(it.angleDeg + rot, RADIUS);
// //               return (
// //                 <div
// //                   key={it.id}
// //                   className="absolute"
...
// //                       animation:"itemPop 0.5s cubic-bezier(0.34,1.45,0.64,1) forwards",
...
// //                       onClick={()=>handleItem(it)}
// //                       aria-label={it.label}
// //                       className="w-full h-full rounded-full flex items-center justify-center overflow-hidden shadow-xl transition-transform duration-200 hover:scale-110 active:scale-95"
// //                       style={{background:it.bg, border:"2px solid rgba(255,255,255,0.35)"}}
// //                     >
// //                       {it.id==="chat"   && <Avatar size={ITEM-4} iconSize={22} />}
// //                       {it.id==="whatsapp" && (
// //                         <img src="/lovable-uploads/WhatsApp-icone.png" alt="WhatsApp" draggable={false} style={{width:22,height:22}} />
// //                       )}
// //                       {it.id==="email"  && <Mail  size={21} color="white" />}
// //                       {it.id==="phone"  && <Phone size={21} color="white" />}
// //                     </button>
// //                   </div>

// //                   <span
// //                     className="absolute text-[10px] font-medium whitespace-nowrap px-1.5 py-0.5 rounded-md pointer-events-none"
// //                     style={{
// //                       top:"100%", left:"50%", transform:"translateX(-50%)", marginTop:4,
// //                       background:dark?"rgba(15,23,42,0.85)":"rgba(255,255,255,0.9)",
// //                       color:dark?"#cbd5e1":"#475569",
...
// //         {!bloomed ? (
// //           <button
// //             onClick={()=>{ setRot(0); setBloomed(true); }}
// //             aria-label="Open quick actions"
// //             className="flex items-center justify-center transition-transform duration-200 active:scale-90"
// //             /* 44x80 invisible hit area so the thin line is actually tappable */
// //             style={{ width:"44px", height:"80px", background:"transparent", padding:0, border:"none" }}
...
// //             onClick={()=>setBloomed(false)}
// //             aria-label="Close quick actions"
// //             className="relative rounded-full flex items-center justify-center shadow-2xl z-[1]"
// //             style={{
// //               width:HUB, height:HUB,
// //               background:dark?"#0f172a":"#ffffff",
// //               border:`2px solid ${dark?"#1e293b":"#e2e8f0"}`,
...
//  *  All four sit on the LEFT arc because the hub hugs the right edge. */
// const RADIAL_ITEMS: RadialItem[] = [
//   { id:"chat",     angleDeg:-112.5, label:"Chat",     bg:"linear-gradient(135deg,#3b82f6,#8b5cf6)", action:"chat" },
//   { id:"whatsapp", angleDeg:-157.5, label:"WhatsApp", bg:"#25D366", action:"link", href:"https://wa.me/918304909105", newTab:true },
//   { id:"email",    angleDeg:-202.5, label:"Email",    bg:"linear-gradient(135deg,#f97316,#ef4444)", action:"link", href:"mailto:thomasjose22@gmail.com" },
//   { id:"phone",    angleDeg:-247.5, label:"Call",     bg:"linear-gradient(135deg,#10b981,#059669)", action:"link", href:"tel:+918304909105" },
// ];

// const MAX_ROT = 22;   // how far the dial can be spun either way (keeps items on the left half)
// const clamp = (v:number,min:number,max:number)=>Math.min(Math.max(v,min),max);
...
//   const RADIUS = 130;   // big enough that a 48px icon + its label never touches its neighbour
//   const HUB    = 58;
//   const ITEM   = 48;
...
import {
  Mail, Phone, Github, Linkedin, MapPin, Send, X, Bot, User,
  Minimize2, Maximize2, Copy, Check, Trash2, ChevronDown,
  PanelRightOpen, Square, MessageCircle, Sun, SunDim, Eye
} from "lucide-react";
import { useState, useEffect, useRef, useCallback } from "react";
import { useToast } from "@/hooks/use-toast";
...
// ── Display preferences: page brightness + eye comfort (warm) mode ──
const clamp = (v:number,min:number,max:number)=>Math.min(Math.max(v,min),max);
const BRIGHT_MIN = 0.55;
const BRIGHT_MAX = 1.35;
const BRIGHT_STEP = 0.1;
const PREF_KEY = "tj-display-prefs";
...
function useDisplayPrefs():DisplayPrefs {
  ...
  useEffect(()=>{
    try{
      ...
      if(typeof p.brightness==="number") setBrightness(clamp(p.brightness,BRIGHT_MIN,BRIGHT_MAX));
      if(typeof p.comfort==="boolean")   setComfort(p.comfort);
    }catch{/* storage blocked or corrupt — keep defaults */}
  },[]);

  useEffect(()=>{
    try{ localStorage.setItem(PREF_KEY, JSON.stringify({brightness,comfort})); }catch{/* ignore */}
  },[brightness,comfort]);

  const step = useCallback((dir:1|-1)=>{
    setBrightness(b=>Math.round(clamp(b+dir*BRIGHT_STEP,BRIGHT_MIN,BRIGHT_MAX)*100)/100);
  },[]);
  const toggleComfort = useCallback(()=>setComfort(v=>!v),[]);
  const reset = useCallback(()=>{ setBrightness(1); setComfort(false); },[]);

  return { brightness, comfort, step, toggleComfort, reset };
}

/** Full-screen filter layer. Sits above everything but ignores pointer events,
 *  so the page keeps working normally underneath it. */
const ScreenTint = ({ brightness, comfort }:{ brightness:number; comfort:boolean }) => {
  if(brightness===1 && !comfort) return null;

  const supportsBackdrop = typeof CSS!=="undefined" && CSS.supports?.("backdrop-filter","brightness(1)");
  const filter = `brightness(${brightness})${comfort?" sepia(0.32) saturate(1.08) hue-rotate(-8deg)":""}`;
  ...
  return (
    <div
      ...
      style={{
        ...
        ...(supportsBackdrop
          ? { backdropFilter:filter, WebkitBackdropFilter:filter as any,
              background: comfort ? "rgba(255,168,74,0.08)" : "transparent" }
          : { // no backdrop-filter: dim with a scrim, warm with a tint
              background: comfort
                ? `rgba(255,150,40,${0.14 + Math.max(0,1-brightness)*0.5})`
                : `rgba(0,0,0,${Math.max(0,1-brightness)})` }),
...
/** Inner ring: display controls. Smaller, icon-only, sits inside the contact ring. */
const INNER_ITEMS = [
  { id:"bright-up",   angleDeg:-125, label:"Brighter" },
  { id:"comfort",     angleDeg:-180, label:"Eye comfort" },
  { id:"bright-down", angleDeg:-235, label:"Dimmer" },
] as const;

const RadialLauncher = ({
  dark, chatOpen, onOpenChat, display,
}:{
  dark:boolean; chatOpen:boolean; onOpenChat:()=>void; display:DisplayPrefs;
}) => {
  const [bloomed, setBloomed] = useState(false);
  const [rot,     setRot]     = useState(0);     // dial rotation in degrees
  const [spinning,setSpinning]= useState(false);
  ...
  const HUB    = 58;
  const ITEM   = 48;
  const IN_RADIUS = 58; // display controls
  const IN_ITEM   = 32;
  ...
  const handleInner = (id:string)=>{
    if(suppressTap.current) return;          // ignore the tap that ended a spin
    if(id==="bright-up")        display.step(1);
    else if(id==="bright-down") display.step(-1);
    else if(id==="comfort")     display.toggleComfort();
    // the dial stays open so brightness can be nudged repeatedly
  };
      ...
      >
        ...
        {bloomed && (
          ...
          >
            ...
            {/* Inner ring — display controls */}
            {INNER_ITEMS.map((it,i)=>{
              const {x,y} = polar(it.angleDeg + rot, IN_RADIUS);
              const on    = it.id==="comfort" && display.comfort;
              const atMax = it.id==="bright-up"   && display.brightness>=BRIGHT_MAX;
              const atMin = it.id==="bright-down" && display.brightness<=BRIGHT_MIN;
              const dim   = atMax || atMin;
              return (
                <div
                  key={it.id}
                  className="absolute"
                  style={{
                    top:"50%", left:"50%",
                    marginTop:-IN_ITEM/2, marginLeft:-IN_ITEM/2,
                    width:IN_ITEM, height:IN_ITEM,
                    transform:`translate(${x}px,${y}px)`,
                    transition: spinning ? "none" : "transform 0.35s cubic-bezier(0.34,1.2,0.64,1)",
                  }}
                >
                  <div
                    style={{
                      width:"100%", height:"100%",
                      animation:"itemPop 0.45s cubic-bezier(0.34,1.45,0.64,1) forwards",
                      animationDelay:`${0.12 + i*0.07}s`,
                      opacity:0,
                    }}
                  >
                    <button
                      onClick={()=>handleInner(it.id)}
                      aria-label={it.label}
                      title={it.label}
                      className="w-full h-full rounded-full flex items-center justify-center shadow-lg transition-transform duration-200 active:scale-90"
                      style={{
                        background: on
                          ? "linear-gradient(135deg,#f59e0b,#f97316)"
                          : dark ? "rgba(30,41,59,0.92)" : "rgba(255,255,255,0.95)",
                        border:`1px solid ${on ? "rgba(255,255,255,0.5)" : dark?"#334155":"#dbe2f0"}`,
                        opacity: dim ? 0.4 : 1,
                      }}
                    >
                      {it.id==="bright-up"   && <Sun    size={16} color={dark?"#e2e8f0":"#475569"} />}
                      {it.id==="bright-down" && <SunDim size={16} color={dark?"#e2e8f0":"#475569"} />}
                      {it.id==="comfort"     && <Eye    size={16} color={on?"#ffffff":dark?"#e2e8f0":"#475569"} />}
                    </button>
                  </div>
                </div>
              );
            ...
            {/* Brightness readout, parked at the top of the dial */}
            <span
              className="absolute text-[10px] font-semibold px-2 py-0.5 rounded-full pointer-events-none"
              style={{
                top:2, left:"50%", transform:"translateX(-50%)",
                background:dark?"rgba(15,23,42,0.9)":"rgba(255,255,255,0.92)",
                color: display.comfort ? "#f59e0b" : dark?"#93c5fd":"#4f46e5",
                border:`1px solid ${dark?"#1e293b":"#e2e8f0"}`,
              }}
            >
              {Math.round(display.brightness*100)}%{display.comfort ? " · warm" : ""}
            </span>
          </div>
        )}
...
// Chatbot Component
// ══════════════════════════════════════════════════════════════════
const Chatbot = ({ display }:{ display:DisplayPrefs }) => {
  const dark = useDark();
  const vh   = useViewportH();
  const mob  = useMobile();
...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20 bg-background">
      ...
      {/* Eye comfort — desktop only (mobile has it on the radial dial) */}
      {!mob && (
        <button
          onClick={display.toggleComfort}
          title={display.comfort ? "Eye comfort on — click to turn off" : "Eye comfort: warm the screen"}
          aria-pressed={display.comfort}
          className="fixed bottom-6 right-24 p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 z-50 flex items-center justify-center"
          style={{
            width:"3.5rem", height:"3.5rem",
            background: display.comfort
              ? "linear-gradient(135deg,#f59e0b,#f97316)"
              : dark ? "#0f172a" : "#ffffff",
            border:`1px solid ${display.comfort ? "rgba(255,255,255,0.45)" : dark ? "#1e293b" : "#e5e7eb"}`,
          }}
        >
          <Eye size={22} color={display.comfort ? "#ffffff" : dark ? "#93c5fd" : "#475569"} />
        </button>
      )}
      ...
      {/* Brightness / warmth layer — must be the last thing rendered */}
      <ScreenTint brightness={display.brightness} comfort={display.comfort} />
    </section>
  );
};

...
// //   // FIX 1: Reduced desktop minHeight from 2000 → auto-fit (~580px).
// //   // The huge 2000px was creating the enormous blank gap seen in images 3 & 4.
// //   const cardMinHeight = isMobile ? 560 : 580;
...
// //             {[
// //               { key: 'all',      label: 'All Projects', icon: null },
// //               { key: 'hardware', label: 'Hardware',     icon: <Cpu  size={13} className="mr-1" /> },
// //               { key: 'frontend', label: 'Frontend',     icon: <Code size={13} className="mr-1" /> },
// //             ].map(({ key, label, icon }) => (
// //               <Button
// //                 key={key}
// //                 variant={activeCategory === key ? "default" : "ghost"}
...
// //       {/* ── Stacked Card Carousel ──
// //           FIX 2: On mobile the carousel breaks OUT of the container (no max-w-6xl / padding)
// //           so cards span the full viewport width edge-to-edge.
// //           On desktop it stays inside a padded max-width wrapper.
// //       ── */}
// //       <div className={`transition-all duration-1000 delay-200 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
...
// //           className="relative"
// //           style={{
// //             // Desktop: constrained & centred; Mobile: full viewport width, no side padding
// //             maxWidth:    isMobile ? '100%'  : 'calc(min(100%, 1152px))',
...
// //           <div
// //             className="relative w-full"
// //             // FIX 3: minHeight uses the corrected cardMinHeight (580 not 2000)
// //             style={{ minHeight: `${cardMinHeight + 48}px`, isolation: 'isolate', overflow: 'hidden' }}
// //             onTouchStart={onTouchStart}
// //             onTouchEnd={onTouchEnd}
// //           >
// //             {filteredProjects.map((project, index) => {
...
// //                       boxShadow:    getShadow(isActive, project.accent),
// //                       minHeight:    `${cardMinHeight}px`,
// //                       // FIX 2 cont.: square corners on mobile for true edge-to-edge feel
// //                       borderRadius: isMobile ? '0px' : '16px',
// //                     }}
// //                   >
// //                     {/* Top accent stripe */}
...
// //                       {/* Features — show ALL on both mobile and desktop */}
// //                       <div className="mb-3 sm:mb-4">
// //                         <h4 className="font-semibold mb-1.5 sm:mb-2 text-xs sm:text-sm" style={{ color: project.accent }}>
// //                           Key Features
// //                         </h4>
...
//         {/* ── Category Filter ── */}
//         {/* On mobile: full-width scrollable strip so pills never clip or wrap */}
//         <div className={`mb-8 sm:mb-14 transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-10"}`}>
//           <div
//             className="flex sm:justify-center px-4 sm:px-6 overflow-x-auto"
//             style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}
//           >
//             <div className="inline-flex flex-nowrap rounded-lg border border-primary/20 bg-muted/50 p-1 gap-0.5 sm:gap-1 flex-shrink-0">
//               {[
//                 { key: 'all',      label: 'All Projects', icon: null },
//                 { key: 'hardware', label: 'Hardware',     icon: <Cpu  size={13} className="mr-1 flex-shrink-0" /> },
//                 { key: 'frontend', label: 'Frontend',     icon: <Code size={13} className="mr-1 flex-shrink-0" /> },
//               ].map(({ key, label, icon }) => (
//                 <Button
//                   key={key}
//                   variant={activeCategory === key ? "default" : "ghost"}
//                   size="sm"
//                   onClick={() => setActiveCategory(key)}
//                   className={`text-xs sm:text-sm px-3 sm:px-4 h-8 sm:h-9 whitespace-nowrap transition-all duration-300 ${
//                     activeCategory === key
//                       ? "bg-primary text-primary-foreground shadow-sm"
//                       : "hover:bg-primary/10 text-muted-foreground"
//                   }`}
